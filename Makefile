...
N64_DIAG_OBJECTS := $(addprefix $(BUILD_DIR)/src/,n64diagnostics.o n64rdpcheck.o sched.o crash.o ramrom.o memp.o boss.o game/lv.o game/bg.o game/rsp.o game/sky.o)
