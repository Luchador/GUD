...
/* 0338AC 7020031C 3C1E7020 */  lui   $fp, %hi(rarezip.ptrbuffer) # $fp, 0x7020
/* 0338B0 70200320 3C137020 */  lui   $s3, %hi(rarezip.data3) # $s3, 0x7020
/* 0338B4 70200324 26731598 */  addiu $s3, %lo(rarezip.data3) # addiu $s3, $s3, 0x1598
/* 0338B8 70200328 27DE1490 */  addiu $fp, %lo(rarezip.ptrbuffer) # addiu $fp, $fp, 0x1490
...
/* 033C08 70200678 3C097020 */  lui   $t1, %hi(rarezip.sample) # $t1, 0x7020
/* 033C0C 7020067C 3C087020 */  lui   $t0, %hi(rarezip.bitsinsample) # $t0, 0x7020
/* 033C10 70200680 3C037020 */  lui   $v1, %hi(rarezip.decompressed_count) # $v1, 0x7020
/* 033C14 70200684 016E7821 */  addu  $t7, $t3, $t6
/* 033C18 70200688 0178C821 */  addu  $t9, $t3, $t8
/* 033C1C 7020068C 3C077020 */  lui   $a3, %hi(rarezip.curoffset) # $a3, 0x7020
/* 033C20 70200690 3C067020 */  lui   $a2, %hi(rarezip.ptr_target) # $a2, 0x7020
/* 033C24 70200694 AFB2000C */  sw    $s2, 0xc($sp)
/* 033C28 70200698 AFA40010 */  sw    $a0, 0x10($sp)
/* 033C2C 7020069C AFA50014 */  sw    $a1, 0x14($sp)
/* 033C30 702006A0 8D291564 */  lw    $t1, %lo(rarezip.sample)($t1)
/* 033C34 702006A4 8D081568 */  lw    $t0, %lo(rarezip.bitsinsample)($t0)
/* 033C38 702006A8 8C63148C */  lw    $v1, %lo(rarezip.decompressed_count)($v1)
/* 033C3C 702006AC 95EC0000 */  lhu   $t4, ($t7)
/* 033C40 702006B0 972D0000 */  lhu   $t5, ($t9)
/* 033C44 702006B4 24C61484 */  addiu $a2, %lo(rarezip.ptr_target) # addiu $a2, $a2, 0x1484
/* 033C48 702006B8 24E71488 */  addiu $a3, %lo(rarezip.curoffset) # addiu $a3, $a3, 0x1488
.L702006BC:
/* 033C4C 702006BC 0110082B */  sltu  $at, $t0, $s0
.L702006C0:
/* 033C50 702006C0 1020000C */  beqz  $at, .L702006F4
/* 033C54 702006C4 3C027020 */   lui   $v0, %hi(rarezip.ptr_source) # $v0, 0x7020
/* 033C58 702006C8 8C421480 */  lw    $v0, %lo(rarezip.ptr_source)($v0)
.L702006CC:
...
/* 033CBC 7020072C 3C027020 */  lui   $v0, %hi(rarezip.ptr_source) # $v0, 0x7020
/* 033CC0 70200730 8C421480 */  lw    $v0, %lo(rarezip.ptr_source)($v0)
.L70200734:
...
/* 033D4C 702007BC 3C027020 */   lui   $v0, %hi(rarezip.ptr_source) # $v0, 0x7020
...
/* 033D5C 702007CC 8C421480 */  lw    $v0, %lo(rarezip.ptr_source)($v0)
.L702007D0:
...
/* 033DB0 70200820 3C027020 */  lui   $v0, %hi(rarezip.ptr_source) # $v0, 0x7020
/* 033DB4 70200824 8C421480 */  lw    $v0, %lo(rarezip.ptr_source)($v0)
.L70200828:
...
/* 033E18 70200888 3C027020 */  lui   $v0, %hi(rarezip.ptr_source) # $v0, 0x7020
/* 033E1C 7020088C 8C421480 */  lw    $v0, %lo(rarezip.ptr_source)($v0)
.L70200890:
...
/* 033E88 702008F8 3C027020 */  lui   $v0, %hi(rarezip.ptr_source) # $v0, 0x7020
/* 033E8C 702008FC 8C421480 */  lw    $v0, %lo(rarezip.ptr_source)($v0)
.L70200900:
...
.L70200A18:
/* 033FA8 70200A18 3C017020 */  lui   $at, %hi(rarezip.decompressed_count) # $at, 0x7020
/* 033FAC 70200A1C AC23148C */  sw    $v1, %lo(rarezip.decompressed_count)($at)
/* 033FB0 70200A20 3C017020 */  lui   $at, %hi(rarezip.sample) # $at, 0x7020
/* 033FB4 70200A24 AC291564 */  sw    $t1, %lo(rarezip.sample)($at)
/* 033FB8 70200A28 3C017020 */  lui   $at, %hi(rarezip.bitsinsample) # $at, 0x7020
/* 033FBC 70200A2C 8FB00004 */  lw    $s0, 4($sp)
/* 033FC0 70200A30 8FB10008 */  lw    $s1, 8($sp)
/* 033FC4 70200A34 8FB2000C */  lw    $s2, 0xc($sp)
/* 033FC8 70200A38 AC281568 */  sw    $t0, %lo(rarezip.bitsinsample)($at)
...
/* 033FD8 70200A48 3C097020 */  lui   $t1, %hi(rarezip.bitsinsample) # $t1, 0x7020
/* 033FDC 70200A4C 25291568 */  addiu $t1, %lo(rarezip.bitsinsample) # addiu $t1, $t1, 0x1568
/* 033FE0 70200A50 8D240000 */  lw    $a0, ($t1)
/* 033FE4 70200A54 3C087020 */  lui   $t0, %hi(rarezip.sample) # $t0, 0x7020
/* 033FE8 70200A58 25081564 */  addiu $t0, %lo(rarezip.sample) # addiu $t0, $t0, 0x1564
/* 033FEC 70200A5C 30820007 */  andi  $v0, $a0, 7
/* 033FF0 70200A60 8D030000 */  lw    $v1, ($t0)
/* 033FF4 70200A64 3C0A7020 */  lui   $t2, %hi(rarezip.decompressed_count) # $t2, 0x7020
/* 033FF8 70200A68 00822023 */  subu  $a0, $a0, $v0
/* 033FFC 70200A6C 254A148C */  addiu $t2, %lo(rarezip.decompressed_count) # addiu $t2, $t2, 0x148c
...
/* 034010 70200A80 3C067020 */  lui   $a2, %hi(rarezip.ptr_source) # $a2, 0x7020
/* 034014 70200A84 3C0B7020 */  lui   $t3, %hi(rarezip.curoffset) # $t3, 0x7020
/* 034018 70200A88 256B1488 */  addiu $t3, %lo(rarezip.curoffset) # addiu $t3, $t3, 0x1488
/* 03401C 70200A8C 8CC61480 */  lw    $a2, %lo(rarezip.ptr_source)($a2)
.L70200A90:
...
/* 03404C 70200ABC 3C0B7020 */  lui   $t3, %hi(rarezip.curoffset) # $t3, 0x7020
...
/* 03405C 70200ACC 256B1488 */  addiu $t3, %lo(rarezip.curoffset) # addiu $t3, $t3, 0x1488
/* 034060 70200AD0 1020000D */  beqz  $at, .L70200B08
/* 034064 70200AD4 01A01825 */   move  $v1, $t5
/* 034068 70200AD8 3C067020 */  lui   $a2, %hi(rarezip.ptr_source) # $a2, 0x7020
/* 03406C 70200ADC 8CC61480 */  lw    $a2, %lo(rarezip.ptr_source)($a2)
.L70200AE0:
...
/* 0340B0 70200B20 3C0C7020 */  lui   $t4, %hi(rarezip.ptr_target) # $t4, 0x7020
/* 0340B4 70200B24 258C1484 */  addiu $t4, %lo(rarezip.ptr_target) # addiu $t4, $t4, 0x1484
.L70200B28:
/* 0340B8 70200B28 2C810008 */  sltiu $at, $a0, 8
/* 0340BC 70200B2C 1020000C */  beqz  $at, .L70200B60
/* 0340C0 70200B30 3C067020 */   lui   $a2, %hi(rarezip.ptr_source) # $a2, 0x7020
/* 0340C4 70200B34 8CC61480 */  lw    $a2, %lo(rarezip.ptr_source)($a2)
.L70200B38:
...
.L70200C34:
/* 0341C4 70200C34 3C087020 */  lui   $t0, %hi(rarezip.lextra) # $t0, 0x7020
/* 0341C8 70200C38 250814E8 */  addiu $t0, %lo(rarezip.lextra) # addiu $t0, $t0, 0x14e8
/* 0341CC 70200C3C 3C077020 */  lui   $a3, %hi(rarezip.lbase) # $a3, 0x7020
...
/* 0341E4 70200C54 24E714A8 */  addiu $a3, %lo(rarezip.lbase) # addiu $a3, $a3, 0x14a8
...
/* 034230 70200CA0 3C0E7020 */  lui   $t6, %hi(rarezip.dextra) # $t6, 0x7020
/* 034234 70200CA4 240D0005 */  li    $t5, 5
/* 034238 70200CA8 25CE1544 */  addiu $t6, %lo(rarezip.dextra) # addiu $t6, $t6, 0x1544
/* 03423C 70200CAC 3C077020 */  lui   $a3, %hi(rarezip.dbase) # $a3, 0x7020
...
/* 034254 70200CC4 24E71508 */  addiu $a3, %lo(rarezip.dbase) # addiu $a3, $a3, 0x1508
...
/* 034294 70200D04 3C087020 */  lui   $t0, %hi(rarezip.bitsinsample) # $t0, 0x7020
/* 034298 70200D08 8D081568 */  lw    $t0, %lo(rarezip.bitsinsample)($t0)
/* 03429C 70200D0C 27BDFA98 */  addiu $sp, $sp, -0x568
/* 0342A0 70200D10 3C097020 */  lui   $t1, %hi(rarezip.sample) # $t1, 0x7020
...
/* 0342B4 70200D24 8D291564 */   lw    $t1, %lo(rarezip.sample)($t1)
/* 0342B8 70200D28 3C037020 */  lui   $v1, %hi(rarezip.ptr_source) # $v1, 0x7020
/* 0342BC 70200D2C 3C0A7020 */  lui   $t2, %hi(rarezip.curoffset) # $t2, 0x7020
/* 0342C0 70200D30 254A1488 */  addiu $t2, %lo(rarezip.curoffset) # addiu $t2, $t2, 0x1488
/* 0342C4 70200D34 8C631480 */  lw    $v1, %lo(rarezip.ptr_source)($v1)
.L70200D38:
...
/* 0342F8 70200D68 3C0A7020 */  lui   $t2, %hi(rarezip.curoffset) # $t2, 0x7020
/* 0342FC 70200D6C 25CF0101 */  addiu $t7, $t6, 0x101
/* 034300 70200D70 0009C142 */  srl   $t8, $t1, 5
/* 034304 70200D74 2D010005 */  sltiu $at, $t0, 5
/* 034308 70200D78 254A1488 */  addiu $t2, %lo(rarezip.curoffset) # addiu $t2, $t2, 0x1488
/* 03430C 70200D7C AFAF053C */  sw    $t7, 0x53c($sp)
/* 034310 70200D80 1020000D */  beqz  $at, .L70200DB8
/* 034314 70200D84 03004825 */   move  $t1, $t8
/* 034318 70200D88 3C037020 */  lui   $v1, %hi(rarezip.ptr_source) # $v1, 0x7020
/* 03431C 70200D8C 8C631480 */  lw    $v1, %lo(rarezip.ptr_source)($v1)
.L70200D90:
...
/* 034368 70200DD8 3C037020 */  lui   $v1, %hi(rarezip.ptr_source) # $v1, 0x7020
/* 03436C 70200DDC 8C631480 */  lw    $v1, %lo(rarezip.ptr_source)($v1)
.L70200DE0:
...
/* 0343B4 70200E24 3C057020 */  lui   $a1, %hi(rarezip.order) # $a1, 0x7020
/* 0343B8 70200E28 24A51494 */  addiu $a1, %lo(rarezip.order) # addiu $a1, $a1, 0x1494
...
/* 0343CC 70200E3C 3C037020 */  lui   $v1, %hi(rarezip.ptr_source) # $v1, 0x7020
/* 0343D0 70200E40 8C631480 */  lw    $v1, %lo(rarezip.ptr_source)($v1)
.L70200E44:
...
/* 034430 70200EA0 3C0F7020 */  lui   $t7, %hi(rarezip.order) # $t7, 0x7020
/* 034434 70200EA4 25EF1494 */  addiu $t7, %lo(rarezip.order) # addiu $t7, $t7, 0x1494
/* 034438 70200EA8 3C027020 */  lui   $v0, %hi(rarezip.order + 0x13) # $v0, 0x7020
/* 03443C 70200EAC 244214A7 */  addiu $v0, %lo(rarezip.order + 0x13) # addiu $v0, $v0, 0x14a7
...
/* 0344AC 70200F1C 3C0A7020 */  lui   $t2, %hi(rarezip.curoffset) # $t2, 0x7020
/* 0344B0 70200F20 01785821 */  addu  $t3, $t3, $t8
/* 0344B4 70200F24 01CF3821 */  addu  $a3, $t6, $t7
/* 0344B8 70200F28 254A1488 */  addiu $t2, %lo(rarezip.curoffset) # addiu $t2, $t2, 0x1488
...
.L70200F50:
/* 0344E0 70200F50 3C037020 */  lui   $v1, %hi(rarezip.ptr_source) # $v1, 0x7020
...
/* 0344F0 70200F60 8C631480 */  lw    $v1, %lo(rarezip.ptr_source)($v1)
.L70200F64:
...
/* 034574 70200FE4 3C037020 */   lui   $v1, %hi(rarezip.ptr_source) # $v1, 0x7020
/* 034578 70200FE8 8C631480 */  lw    $v1, %lo(rarezip.ptr_source)($v1)
.L70200FEC:
...
/* 0345FC 7020106C 3C037020 */   lui   $v1, %hi(rarezip.ptr_source) # $v1, 0x7020
/* 034600 70201070 8C631480 */  lw    $v1, %lo(rarezip.ptr_source)($v1)
.L70201074:
...
/* 03467C 702010EC 3C037020 */   lui   $v1, %hi(rarezip.ptr_source) # $v1, 0x7020
/* 034680 702010F0 8C631480 */  lw    $v1, %lo(rarezip.ptr_source)($v1)
.L702010F4:
...
.L70201168:
/* 0346F8 70201168 3C017020 */  lui   $at, %hi(rarezip.sample) # $at, 0x7020
/* 0346FC 7020116C 3C197020 */  lui   $t9, %hi(rarezip.data1) # $t9, 0x7020
/* 034700 70201170 8F391590 */  lw    $t9, %lo(rarezip.data1)($t9)
/* 034704 70201174 AC291564 */  sw    $t1, %lo(rarezip.sample)($at)
/* 034708 70201178 3C187020 */  lui   $t8, %hi(rarezip.lextra) # $t8, 0x7020
/* 03470C 7020117C 3C017020 */  lui   $at, %hi(rarezip.bitsinsample) # $at, 0x7020
/* 034710 70201180 271814E8 */  addiu $t8, %lo(rarezip.lextra) # addiu $t8, $t8, 0x14e8
/* 034714 70201184 3C077020 */  lui   $a3, %hi(rarezip.lbase) # $a3, 0x7020
/* 034718 70201188 27AE0550 */  addiu $t6, $sp, 0x550
/* 03471C 7020118C 27AF0548 */  addiu $t7, $sp, 0x548
/* 034720 70201190 AC281568 */  sw    $t0, %lo(rarezip.bitsinsample)($at)
/* 034724 70201194 AFAF0018 */  sw    $t7, 0x18($sp)
/* 034728 70201198 AFAE0014 */  sw    $t6, 0x14($sp)
/* 03472C 7020119C 24E714A8 */  addiu $a3, %lo(rarezip.lbase) # addiu $a3, $a3, 0x14a8
...
/* 034748 702011B8 3C197020 */  lui   $t9, %hi(rarezip.data2) # $t9, 0x7020
/* 03474C 702011BC 8F391594 */  lw    $t9, %lo(rarezip.data2)($t9)
/* 034750 702011C0 8FB8053C */  lw    $t8, 0x53c($sp)
/* 034754 702011C4 3C0F7020 */  lui   $t7, %hi(rarezip.dextra) # $t7, 0x7020
...
/* 034768 702011D8 25EF1544 */  addiu $t7, %lo(rarezip.dextra) # addiu $t7, $t7, 0x1544
/* 03476C 702011DC 3C077020 */  lui   $a3, %hi(rarezip.dbase) # $a3, 0x7020
/* 034770 702011E0 24E71508 */  addiu $a3, %lo(rarezip.dbase) # addiu $a3, $a3, 0x1508
...
/* 0347B8 70201228 3C097020 */  lui   $t1, %hi(rarezip.bitsinsample) # $t1, 0x7020
/* 0347BC 7020122C 25291568 */  addiu $t1, %lo(rarezip.bitsinsample) # addiu $t1, $t1, 0x1568
/* 0347C0 70201230 8D230000 */  lw    $v1, ($t1)
/* 0347C4 70201234 3C087020 */  lui   $t0, %hi(rarezip.sample) # $t0, 0x7020
/* 0347C8 70201238 25081564 */  addiu $t0, %lo(rarezip.sample) # addiu $t0, $t0, 0x1564
...
/* 0347E0 70201250 3C067020 */  lui   $a2, %hi(rarezip.ptr_source) # $a2, 0x7020
/* 0347E4 70201254 3C047020 */  lui   $a0, %hi(rarezip.curoffset) # $a0, 0x7020
/* 0347E8 70201258 24841488 */  addiu $a0, %lo(rarezip.curoffset) # addiu $a0, $a0, 0x1488
/* 0347EC 7020125C 8CC61480 */  lw    $a2, %lo(rarezip.ptr_source)($a2)
.L70201260:
...
/* 034818 70201288 3C047020 */  lui   $a0, %hi(rarezip.curoffset) # $a0, 0x7020
/* 03481C 7020128C 30AA0001 */  andi  $t2, $a1, 1
/* 034820 70201290 00055842 */  srl   $t3, $a1, 1
/* 034824 70201294 2C610002 */  sltiu $at, $v1, 2
/* 034828 70201298 24841488 */  addiu $a0, %lo(rarezip.curoffset) # addiu $a0, $a0, 0x1488
/* 03482C 7020129C ACEA0000 */  sw    $t2, ($a3)
/* 034830 702012A0 1020000D */  beqz  $at, .L702012D8
/* 034834 702012A4 01602825 */   move  $a1, $t3
/* 034838 702012A8 3C067020 */  lui   $a2, %hi(rarezip.ptr_source) # $a2, 0x7020
/* 03483C 702012AC 8CC61480 */  lw    $a2, %lo(rarezip.ptr_source)($a2)
.L702012B0:
...
/* 0348E4 70201354 3C127020 */  lui   $s2, %hi(rarezip.bitsinsample) # $s2, 0x7020
/* 0348E8 70201358 AC20148C */  sw    $zero, %lo(rarezip.decompressed_count)($at)
/* 0348EC 7020135C 26521568 */  addiu $s2, %lo(rarezip.bitsinsample) # addiu $s2, $s2, 0x1568
...
/* 034900 70201370 3C017020 */  lui   $at, %hi(rarezip.sample) # $at, 0x7020
/* 034904 70201374 3C107020 */  lui   $s0, %hi(rarezip.data3) # $s0, 0x7020
/* 034908 70201378 AFBF0024 */  sw    $ra, 0x24($sp)
/* 03490C 7020137C AC201564 */  sw    $zero, %lo(rarezip.sample)($at)
/* 034910 70201380 00008825 */  move  $s1, $zero
/* 034914 70201384 26101598 */  addiu $s0, %lo(rarezip.data3) # addiu $s0, $s0, 0x1598
...
/* 034958 702013C8 3C027020 */  lui   $v0, %hi(rarezip.curoffset) # $v0, 0x7020
/* 03495C 702013CC 24421488 */  addiu $v0, %lo(rarezip.curoffset) # addiu $v0, $v0, 0x1488
...
/* 0349B8 70201428 3C017020 */  lui   $at, %hi(rarezip.ptr_target) # $at, 0x7020
/* 0349BC 7020142C AC251484 */  sw    $a1, %lo(rarezip.ptr_target)($at)
/* 0349C0 70201430 3C017020 */  lui   $at, %hi(rarezip.ptrbuffer) # $at, 0x7020
/* 0349C4 70201434 AC261490 */  sw    $a2, %lo(rarezip.ptrbuffer)($at)
/* 0349C8 70201438 8C4E0000 */  lw    $t6, ($v0)
/* 0349CC 7020143C 3C017020 */  lui   $at, %hi(rarezip.decompressed_count) # $at, 0x7020
/* 0349D0 70201440 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 0349D4 70201444 25CF0002 */  addiu $t7, $t6, 2
/* 0349D8 70201448 AC4F0000 */  sw    $t7, ($v0)
/* 0349DC 7020144C AC20148C */  sw    $zero, %lo(rarezip.decompressed_count)($at)
/* 0349E0 70201450 AFBF0014 */  sw    $ra, 0x14($sp)
/* 0349E4 70201454 3C017020 */  lui   $at, %hi(rarezip.curoffset) # $at, 0x7020
/* 0349E8 70201458 0C0804D2 */  jal   decompress.start
/* 0349EC 7020145C AC201488 */   sw    $zero, %lo(rarezip.curoffset)($at)
/* 0349F0 70201460 8FBF0014 */  lw    $ra, 0x14($sp)
/* 0349F4 70201464 3C027020 */  lui   $v0, %hi(rarezip.decompressed_count) # $v0, 0x7020
