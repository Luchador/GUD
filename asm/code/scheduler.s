...
/* 0015B4 700009B4 3C0F8002 */   lui   $t7, %hi(stderr.activated) # $t7, 0x8002
/* 0015B8 700009B8 8DEF3098 */  lw    $t7, %lo(stderr.activated)($t7)
/* 0015BC 700009BC 15E00004 */  bnez  $t7, .L700009D0
.L700009C0:
/* 0015C0 700009C0 3C188002 */   lui   $t8, %hi(stderr.enable) # $t8, 0x8002
...
.L700009D0:
/* 0015D0 700009D0 0C001674 */  jal   proc_video_related
...
/* 001608 70000A08 3C0F8002 */  lui   $t7, %hi(stderr.permitted) # $t7, 0x8002
/* 00160C 70000A0C 8DEF309C */  lw    $t7, %lo(stderr.permitted)($t7)
/* 001610 70000A10 3C188002 */  lui   $t8, %hi(stderr.activated) # $t8, 0x8002
/* 001614 70000A14 3C198002 */  lui   $t9, %hi(stderr.enable) # $t9, 0x8002
...
/* 001664 70000A64 0C001674 */  jal   proc_video_related
...
/* 001670 70000A70 0C001674 */  jal   proc_video_related
...
/* 001738 70000B38 3C038006 */  lui   $v1, %hi(D_8006087C) # $v1, 0x8006
...
/* 00174C 70000B4C 2463087C */  addiu $v1, %lo(D_8006087C) # addiu $v1, $v1, 0x87c
/* 001750 70000B50 01095021 */  addu  $t2, $t0, $t1
/* 001754 70000B54 AC6A0000 */  sw    $t2, ($v1)
/* 001758 70000B58 8D4B001C */  lw    $t3, 0x1c($t2)
/* 00175C 70000B5C 3C018006 */  lui   $at, %hi(D_80060880) # $at, 0x8006
/* 001760 70000B60 24040004 */  li    $a0, 4
/* 001764 70000B64 AC2B0880 */  sw    $t3, %lo(D_80060880)($at)
/* 001768 70000B68 8D4C0030 */  lw    $t4, 0x30($t2)
/* 00176C 70000B6C 3C018006 */  lui   $at, %hi(D_80060884) # $at, 0x8006
/* 001770 70000B70 02202825 */  move  $a1, $s1
/* 001774 70000B74 AC2C0884 */  sw    $t4, %lo(D_80060884)($at)
/* 001778 70000B78 8D4D0044 */  lw    $t5, 0x44($t2)
/* 00177C 70000B7C 3C018006 */  lui   $at, %hi(D_80060888) # $at, 0x8006
/* 001780 70000B80 2406029B */  li    $a2, 667
/* 001784 70000B84 0C003714 */  jal   osSetEventMesg
/* 001788 70000B88 AC2D0888 */   sw    $t5, %lo(D_80060888)($at)
...
/* 0017D8 70000BD8 3C067000 */  lui   $a2, %hi(shed_entry) # $a2, 0x7000
/* 0017DC 70000BDC 240E001E */  li    $t6, 30
/* 0017E0 70000BE0 AFAE0014 */  sw    $t6, 0x14($sp)
/* 0017E4 70000BE4 24C60D00 */  addiu $a2, %lo(shed_entry) # addiu $a2, $a2, 0xd00
...
/* 001A00 70000E00 3C048002 */  lui   $a0, %hi(D_80027320) # $a0, 0x8002
/* 001A04 70000E04 0C003818 */  jal   osViSetMode
/* 001A08 70000E08 24847320 */   addiu $a0, %lo(D_80027320) # addiu $a0, $a0, 0x7320
...
.L70000F24:
/* 001B24 70000F24 0C0004F6 */  jal   scheduler_related_8
...
/* 001B64 70000F64 0C000558 */  jal   scheduler_related_9
...
/* 001B90 70000F90 0C000567 */  jal   tlb_related_0
...
/* 001CB8 700010B8 0C00048C */  jal   scheduler_related_7
...
/* 001CE4 700010E4 0C000567 */  jal   tlb_related_0
...
/* 001D58 70001158 3C048006 */  lui   $a0, %hi(D_8005DB30) # $a0, 0x8006
/* 001D5C 7000115C 0C0038F0 */  jal   osDpGetCounters
/* 001D60 70001160 2484DB30 */   addiu $a0, %lo(D_8005DB30) # addiu $a0, $a0, -0x24d0
...
/* 001D7C 7000117C 0C00048C */  jal   scheduler_related_7
...
/* 001DA8 700011A8 0C000567 */  jal   tlb_related_0
...
/* 001EE0 700012E0 3C0F8006 */  lui   $t7, %hi(D_8005DB40) # $t7, 0x8006
/* 001EE4 700012E4 25EFDB40 */  addiu $t7, %lo(D_8005DB40) # addiu $t7, $t7, -0x24c0
...
/* 00222C 7000162C 0C000478 */  jal   scheduler_related_6
