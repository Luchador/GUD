...
/* 00111C 7000051C 0C00012F */  jal   (get_rodata_vaddr-0x10000000)
/* 001120 70000520 AFB0001C */   sw    $s0, 0x1c($sp)
/* 001124 70000524 0C000132 */  jal   (get_rodata_rom_start-0x10000000)
/* 001128 70000528 00408025 */   move  $s0, $v0
/* 00112C 7000052C 0C000135 */  jal   (get_rodata_rom_end-0x10000000)
/* 001130 70000530 AFA20034 */   sw    $v0, 0x34($sp)
/* 001134 70000534 8FAE0034 */  lw    $t6, 0x34($sp)
/* 001138 70000538 0C000138 */  jal   (getRareZipASMRomstart-0x10000000)
/* 00113C 7000053C 004E8823 */   subu  $s1, $v0, $t6
/* 001140 70000540 0C00013B */  jal   (getRareZipASMRomend-0x10000000)
...
.L7000058C:
/* 00118C 7000058C 0C00013E */  jal   (jump_decompressfile-0x10000000)
/* 001190 70000590 01512023 */   subu  $a0, $t2, $s1
/* 001194 70000594 3C0B0003 */  lui   $t3, %hi(D_00033590) # $t3, 3
/* 001198 70000598 3C0C0000 */  lui   $t4, %hi(D_00001050) # $t4, 0
/* 00119C 7000059C 258C1050 */  addiu $t4, %lo(D_00001050) # addiu $t4, $t4, 0x1050
/* 0011A0 700005A0 256B3590 */  addiu $t3, %lo(D_00033590) # addiu $t3, $t3, 0x3590
...
/* 001218 70000618 3C027000 */  lui   $v0, %hi(tlb_entries) # $v0, 0x7000
/* 00121C 7000061C 3C048000 */  lui   $a0, (0x80000080 >> 16) # lui $a0, 0x8000
/* 001220 70000620 24421B60 */  addiu $v0, %lo(tlb_entries) # addiu $v0, $v0, 0x1b60
...
/* 0012A8 700006A8 3C108006 */  lui   $s0, %hi(D_8005D640) # $s0, 0x8006
/* 0012AC 700006AC 2610D640 */  addiu $s0, %lo(D_8005D640) # addiu $s0, $s0, -0x29c0
...
/* 001350 70000750 3C048006 */  lui   $a0, %hi(D_8005D490) # $a0, 0x8006
/* 001354 70000754 3C067000 */  lui   $a2, %hi(idle_entry) # $a2, 0x7000
/* 001358 70000758 24C60718 */  addiu $a2, %lo(idle_entry) # addiu $a2, $a2, 0x718
/* 00135C 7000075C 2484D490 */  addiu $a0, %lo(D_8005D490) # addiu $a0, $a0, -0x2b70
...
/* 001374 70000774 3C048006 */  lui   $a0, %hi(D_8005D490) # $a0, 0x8006
/* 001378 70000778 0C003560 */  jal   osStartThread
/* 00137C 7000077C 2484D490 */   addiu $a0, %lo(D_8005D490) # addiu $a0, $a0, -0x2b70
...
/* 0013A8 700007A8 3C048006 */  lui   $a0, %hi(_DATA_END) # $a0, 0x8006
/* 0013AC 700007AC 3C067001 */  lui   $a2, %hi(rmon_entry) # $a2, 0x7001
/* 0013B0 700007B0 240E00FA */  li    $t6, 250
/* 0013B4 700007B4 AFAE0014 */  sw    $t6, 0x14($sp)
/* 0013B8 700007B8 24C6CEA0 */  addiu $a2, %lo(rmon_entry) # addiu $a2, $a2, -0x3160
/* 0013BC 700007BC 2484D2E0 */  addiu $a0, %lo(_DATA_END) # addiu $a0, $a0, -0x2d20
...
/* 0013D0 700007D0 3C048006 */  lui   $a0, %hi(_DATA_END) # $a0, 0x8006
/* 0013D4 700007D4 0C003560 */  jal   osStartThread
/* 0013D8 700007D8 2484D2E0 */   addiu $a0, %lo(_DATA_END) # addiu $a0, $a0, -0x2d20
...
/* 0013F4 700007F4 3C048006 */  lui   $a0, %hi(D_8005D9A0) # $a0, 0x8006
/* 0013F8 700007F8 3C058006 */  lui   $a1, %hi(D_8005D9B8) # $a1, 0x8006
/* 0013FC 700007FC 24A5D9B8 */  addiu $a1, %lo(D_8005D9B8) # addiu $a1, $a1, -0x2648
/* 001400 70000800 2484D9A0 */  addiu $a0, %lo(D_8005D9A0) # addiu $a0, $a0, -0x2660
...
/* 001428 70000828 3C058006 */  lui   $a1, %hi(D_8005D7F0) # $a1, 0x8006
/* 00142C 7000082C 24A5D7F0 */  addiu $a1, %lo(D_8005D7F0) # addiu $a1, $a1, -0x2810
...
.L70000848:
/* 001448 70000848 3C058006 */  lui   $a1, %hi(D_8005D7F0) # $a1, 0x8006
/* 00144C 7000084C 24A5D7F0 */  addiu $a1, %lo(D_8005D7F0) # addiu $a1, $a1, -0x2810
...
/* 001460 70000860 3C058006 */  lui   $a1, %hi(D_8005DB18) # $a1, 0x8006
/* 001464 70000864 3C068006 */  lui   $a2, %hi(D_8005D9A0) # $a2, 0x8006
/* 001468 70000868 24C6D9A0 */  addiu $a2, %lo(D_8005D9A0) # addiu $a2, $a2, -0x2660
/* 00146C 7000086C 24A5DB18 */  addiu $a1, %lo(D_8005DB18) # addiu $a1, $a1, -0x24e8
/* 001470 70000870 2484DA40 */  addiu $a0, %lo(D_8005DA40) # addiu $a0, $a0, -0x25c0
/* 001474 70000874 0C000305 */  jal   scheduler_audio_related
/* 001478 70000878 00003825 */   move  $a3, $zero
/* 00147C 7000087C 3C048006 */  lui   $a0, %hi(D_8005DA40) # $a0, 0x8006
/* 001480 70000880 0C00033E */  jal   scheduler_related_1
/* 001484 70000884 2484DA40 */   addiu $a0, %lo(D_8005DA40) # addiu $a0, $a0, -0x25c0
/* 001488 70000888 8FBF0014 */  lw    $ra, 0x14($sp)
/* 00148C 7000088C 3C018006 */  lui   $at, %hi(D_8005DA38) # $at, 0x8006
/* 001490 70000890 AC22DA38 */  sw    $v0, %lo(D_8005DA38)($at)
