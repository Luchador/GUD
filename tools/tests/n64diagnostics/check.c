...
static void test_task_check_matching(void)
{
    ...
    assert(g_DiagRunningCheck.depthImage == 0x1840 && g_DiagRunningCheck.depthWriteDraws == 3);
    assert(g_DiagCheck.depthImage == 0x2040 && g_DiagCheck.depthWriteDraws == 7);
...
static void write_preview(const char *path)
{
    ...
    g_DiagCheck.depthImage = 0x0023e280;
    g_DiagCheck.depthColor = 0x003b5000;
    g_DiagCheck.depthWidth = 320;
    g_DiagCheck.depthMode = 0x0c19286c;
    g_DiagCheck.depthCompareDraws = 0;
    g_DiagCheck.depthWriteDraws = 233;
    g_DiagCheck.depthCommand = 0x000c7180;
    g_DiagCheck.depthDraw = 0x0021a858;
