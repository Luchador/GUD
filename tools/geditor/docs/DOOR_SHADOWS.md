...
and even a UV seam along the original diagonal is preserved. The N64 rounds
new vertex positions and UVs to their native precision.
...
allocates 18 transient vertices per visible shadow; unused triangles degenerate.
...
room cache lifecycle and allocation failures. Host tests do not rasterize an
N64 frame; emulator visual verification is still required.
