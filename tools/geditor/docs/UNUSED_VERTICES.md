...
Room IDs, portals and other stream addresses stay unchanged. Removed records'
space is cleared and excluded from the block length; later recompilation can
reclaim it. This is particularly important because GoldenEye computes room
