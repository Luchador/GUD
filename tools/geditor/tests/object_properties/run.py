...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='geditor-object-properties-') as temp:
        ...
        command += [str(src / name) for name in ('setupload.c', 'actionblocks.c', 'bghistory.c', 'modelload.c', 'modelmaterials.c')]
        ...
        names = ('ObjectPropertiesHasAim', 'ObjectPropertiesAimFields', 'ObjectPropertiesAimPad',
                 ...
                 'ObjectPropertiesApply', 'ObjectPropertiesGlassField', 'ObjectPropertiesResetGlass',
