...
/* 003C98 70003098 3C09803B */  lui   $t1, %hi(vid_buff_1) # $t1, 0x803b
/* 003C9C 7000309C 0322C823 */  subu  $t9, $t9, $v0
/* 003CA0 700030A0 25295000 */  addiu $t1, %lo(vid_buff_1) # addiu $t1, $t1, 0x5000
...
void *init_both_video_buffers(void) {
    ...
    // Node 1
    temp_v0 = (&vid_buff_1 + 0);
    *temp_v0 = (u8)0;
    temp_v1 = (&vid_buff_2 + 0);
    *temp_v1 = (u8)0;
    temp_v0->unk1 = (u8)0;
    temp_v1->unk1 = (u8)0;
    temp_v0->unk2 = (u8)0;
...
/* 003D38 70003138 3C06803E */  lui   $a2, %hi(vid_buff_2) # $a2, 0x803e
/* 003D3C 7000313C 3C05803B */  lui   $a1, %hi(vid_buff_1) # $a1, 0x803b
/* 003D40 70003140 24A55000 */  addiu $a1, %lo(vid_buff_1) # addiu $a1, $a1, 0x5000
/* 003D44 70003144 24C6A800 */  addiu $a2, %lo(vid_buff_2) # addiu $a2, $a2, -0x5800
...
/* 003DDC 700031DC 3C028006 */  lui   $v0, %hi(dword_CODE_bss_80060884) # $v0, 0x8006
/* 003DE0 700031E0 8C4D0884 */  lw    $t5, %lo(dword_CODE_bss_80060884)($v0)
/* 003DE4 700031E4 03190019 */  multu $t8, $t9
/* 003DE8 700031E8 3C058006 */  lui   $a1, %hi(dword_CODE_bss_8006087C) # $a1, 0x8006
/* 003DEC 700031EC 24A5087C */  addiu $a1, %lo(dword_CODE_bss_8006087C) # addiu $a1, $a1, 0x87c
/* 003DF0 700031F0 000D4C03 */  sra   $t1, $t5, 0x10
/* 003DF4 700031F4 8CB90000 */  lw    $t9, ($a1)
/* 003DF8 700031F8 3C028006 */  lui   $v0, %hi(dword_CODE_bss_80060888) # $v0, 0x8006
...
/* 003E18 70003218 8C4E0888 */  lw    $t6, %lo(dword_CODE_bss_80060888)($v0)
...
/* 003F0C 7000330C 3C038006 */  lui   $v1, %hi(dword_CODE_bss_8006087C) # $v1, 0x8006
/* 003F10 70003310 3C0F8000 */  lui   $t7, 0x8000
/* 003F14 70003314 1300002B */  beqz  $t8, .L700033C4
/* 003F18 70003318 2463087C */   addiu $v1, %lo(dword_CODE_bss_8006087C) # addiu $v1, $v1, 0x87c
...
/* 004074 70003474 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060880) # $at, 0x8006
/* 004078 70003478 00002025 */  move  $a0, $zero
/* 00407C 7000347C AC2E0880 */  sw    $t6, %lo(dword_CODE_bss_80060880)($at)
/* 004080 70003480 8F2F0030 */  lw    $t7, 0x30($t9)
/* 004084 70003484 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060884) # $at, 0x8006
/* 004088 70003488 AC2F0884 */  sw    $t7, %lo(dword_CODE_bss_80060884)($at)
/* 00408C 7000348C 8F380044 */  lw    $t8, 0x44($t9)
/* 004090 70003490 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060888) # $at, 0x8006
/* 004094 70003494 0C000C64 */  jal   video_related_6
/* 004098 70003498 AC380888 */   sw    $t8, %lo(dword_CODE_bss_80060888)($at)
...
/* 0040AC 700034AC 3C038006 */  lui   $v1, %hi(dword_CODE_bss_8006087C) # $v1, 0x8006
...
/* 0040E0 700034E0 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060880) # $at, 0x8006
/* 0040E4 700034E4 00002025 */  move  $a0, $zero
/* 0040E8 700034E8 8C58001C */  lw    $t8, 0x1c($v0)
/* 0040EC 700034EC AC380880 */  sw    $t8, %lo(dword_CODE_bss_80060880)($at)
/* 0040F0 700034F0 8C590030 */  lw    $t9, 0x30($v0)
/* 0040F4 700034F4 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060884) # $at, 0x8006
/* 0040F8 700034F8 AC390884 */  sw    $t9, %lo(dword_CODE_bss_80060884)($at)
/* 0040FC 700034FC 8C4E0044 */  lw    $t6, 0x44($v0)
/* 004100 70003500 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060888) # $at, 0x8006
/* 004104 70003504 0C0038B4 */  jal   osViBlack
/* 004108 70003508 AC2E0888 */   sw    $t6, %lo(dword_CODE_bss_80060888)($at)
.L7000350C:
...
/* 004184 70003584 3C018002 */  lui   $at, 0x8002
/* 004188 70003588 000A4880 */  sll   $t1, $t2, 2
/* 00418C 7000358C 00290821 */  addu  $at, $at, $t1
/* 004190 70003590 E42230B4 */  swc1  $f2, 0x30b4($at)
/* 004194 70003594 3C018002 */  lui   $at, 0x8002
/* 004198 70003598 00290821 */  addu  $at, $at, $t1
/* 00419C 7000359C E42030BC */  swc1  $f0, 0x30bc($at)
...
/* 004498 70003898 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060880) # $at, 0x8006
/* 00449C 7000389C AC240880 */  sw    $a0, %lo(dword_CODE_bss_80060880)($at)
...
/* 004520 70003920 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060884) # $at, 0x8006
/* 004524 70003924 AC240884 */  sw    $a0, %lo(dword_CODE_bss_80060884)($at)
...
/* 0045A8 700039A8 3C018006 */  lui   $at, %hi(dword_CODE_bss_80060888) # $at, 0x8006
/* 0045AC 700039AC AC240888 */  sw    $a0, %lo(dword_CODE_bss_80060888)($at)
/* 0045B0 700039B0 3C018002 */  lui   $at, 0x8002
/* 0045B4 700039B4 00290821 */  addu  $at, $at, $t1
/* 0045B8 700039B8 10000006 */  b     .L700039D4
/* 0045BC 700039BC AC2E30C4 */   sw    $t6, 0x30c4($at)
.L700039C0:
/* 0045C0 700039C0 3C018002 */  lui   $at, 0x8002
...
/* 0045D0 700039D0 AC2030C4 */  sw    $zero, 0x30c4($at)
.L700039D4:
...
/* 004614 70003A14 3C0E803B */  lui   $t6, %hi(vid_buff_1) # $t6, 0x803b
/* 004618 70003A18 25CE5000 */  addiu $t6, %lo(vid_buff_1) # addiu $t6, $t6, 0x5000
...
/* 0046C0 70003AC0 3C0E803B */  lui   $t6, %hi(vid_buff_1) # $t6, 0x803b
/* 0046C4 70003AC4 25CE5000 */  addiu $t6, %lo(vid_buff_1) # addiu $t6, $t6, 0x5000
...
void video_related_A(s32 arg0) {
    ...
    // (possible return value: osRecvMesg(&vi_c_debug_MQ, 0, 1))
}
...
/* 0047C0 70003BC0 3C028003 */  lui   $v0, 0x8003
/* 0047C4 70003BC4 A1C40000 */  sb    $a0, ($t6)
/* 0047C8 70003BC8 00431021 */  addu  $v0, $v0, $v1
/* 0047CC 70003BCC 84428480 */  lh    $v0, -0x7b80($v0)
...
/* 0047E0 70003BE0 3C028003 */  lui   $v0, 0x8003
/* 0047E4 70003BE4 00431021 */  addu  $v0, $v0, $v1
/* 0047E8 70003BE8 84428488 */  lh    $v0, -0x7b78($v0)
...
void get_video2buf_offset28(void) {
    // (possible return value: ptr_video_settings2->unk28)
}
...
void get_video1buf_offset28(void) {
    // (possible return value: ptr_video_settings1->unk28)
}
...
void *video_related_11(void *arg0) {
    ...
    *temp_s0 = 0xed000000;
    ...
    temp_s0_2->unk4 = 0x10001;
    *temp_s0_2 = 0xf7000000;
    if (get_video2_settings_uly() > 0)
    {
        ...
        {
            // Node 2
            temp_s0_10 = (temp_s0_4 + 8);
            *sp58 = (s32) (((((get_video2_settings_uly() + -1) & 0x3ff) * 4) | 0xf6000000) | (((((s32) (get_video2_settings_txtClipW() << 0x10) >> 0x10) + -1) & 0x3ff) << 0xe));
            sp58->unk4 = 0;
            *temp_s0_10 = 0xe7000000;
            temp_s0_10->unk4 = 0;
        }
    }
    // Node 3
    if (get_num_players() == 1)
    {
        ...
        {
            // Node 5
            temp_s0_9 = (temp_s0_4 + 8);
            *sp50 = (s32) (((((get_video2_settings_txtClipH() + -1) & 0x3ff) * 4) | 0xf6000000) | (((((s32) (get_video2_settings_txtClipW() << 0x10) >> 0x10) + -1) & 0x3ff) << 0xe));
            sp50->unk4 = (s32) (((get_video2_settings_height() + ((s32) (get_video2_settings_uly() << 0x10) >> 0x10)) & 0x3ff) * 4);
            temp_s0_9->unk4 = 0;
            *temp_s0_9 = 0xe7000000;
            return;
            // (possible return value: temp_s0_4)
        }
    }
    else
    {
        ...
        if (sub_GAME_7F09B4D8(get_cur_playernum()) == 0)
        {
            ...
            {
                // Node 8
                temp_s0_8 = (temp_s0_4 + 8);
                *sp48 = (s32) (((((get_video2_settings_txtClipH() + -1) & 0x3ff) * 4) | 0xf6000000) | (((((s32) (get_video2_settings_txtClipW() << 0x10) >> 0x10) + -1) & 0x3ff) << 0xe));
                sp22 = get_video2_settings_height();
                sp48->unk4 = (s32) ((((get_video2_settings_height() + ((s32) (get_video2_settings_uly() << 0x10) >> 0x10)) + sp22) & 0x3ff) * 4);
                *temp_s0_8 = 0xe7000000;
                temp_s0_8->unk4 = 0;
            }
            // Node 9
            temp_s0_3 = (temp_s0_4 + 8);
            temp_s0_4->unk4 = 0x1dc;
            *temp_s0_4 = (s32) (((((get_video2_settings_txtClipW() + -1) & 0x3ff) << 0xe) | 0xf6000000) | 0x1e0);
            *temp_s0_3 = 0xe7000000;
            temp_s0_3->unk4 = 0;
            temp_s0_7 = (temp_s0_3 + 8);
            if (get_num_players() >= 3)
            {
                // Node 10
                temp_s0_6 = (temp_s0_7 + 8);
                *temp_s0_7 = (s32) ((((get_video2_settings_txtClipH() + -1) & 0x3ff) * 4) | 0xf6280000);
                temp_s0_7->unk4 = 0x27c000;
                *temp_s0_6 = 0xe7000000;
                temp_s0_6->unk4 = 0;
            }
            // Node 11
            if (get_num_players() == 3)
            {
                // Node 12
                temp_s0_5 = (temp_s0_7 + 8);
                *sp30 = (s32) (((((get_video2_settings_txtClipH() + -1) & 0x3ff) * 4) | 0xf6000000) | (((((s32) (get_video2_settings_txtClipW() << 0x10) >> 0x10) + -1) & 0x3ff) << 0xe));
                sp30->unk4 = 0x2841e4;
                *temp_s0_5 = 0xe7000000;
                temp_s0_5->unk4 = 0;
                return;
                // (possible return value: temp_s0_4)
            }
...
/* 004FBC 700043BC 8C480000 */  lw    $t0, ($v0)
/* 004FC0 700043C0 AFA40000 */  sw    $a0, ($sp)
/* 004FC4 700043C4 AFA50004 */  sw    $a1, 4($sp)
/* 004FC8 700043C8 A5040018 */  sh    $a0, 0x18($t0)
/* 004FCC 700043CC 8C490000 */  lw    $t1, ($v0)
...
void get_video2_settings_offset_18(void) {
    // (possible return value: ptr_video_settings2->unk18)
}
...
void get_video2_settings_offset_1A(void) {
    // (possible return value: ptr_video_settings2->unk1A)
}
...
#ifdef NONMATCHING
void *set_video2_text_clip_size(s16 arg0, s16 arg1) {
    // Node 0
    ptr_video_settings2->unk4 = arg0;
    ptr_video_settings2->unk6 = arg1;
    return;
    // (possible return value: &ptr_video_settings2)
}
...
/* 005000 70004400 8C480000 */  lw    $t0, ($v0)
/* 005004 70004404 AFA40000 */  sw    $a0, ($sp)
/* 005008 70004408 AFA50004 */  sw    $a1, 4($sp)
/* 00500C 7000440C A5040004 */  sh    $a0, 4($t0)
/* 005010 70004410 8C490000 */  lw    $t1, ($v0)
...
void get_video2_settings_txtClipW(void) {
    // (possible return value: ptr_video_settings2->unk4)
}
...
void get_video2_settings_txtClipH(void) {
    // (possible return value: ptr_video_settings2->unk6)
}
...
void get_video2_settings_height(void) {
    // (possible return value: ptr_video_settings2->unk1E)
}
...
void get_video2_settings_ulx(void) {
    // (possible return value: ptr_video_settings2->unk20)
}
...
void get_video2_settings_uly(void) {
    // (possible return value: ptr_video_settings2->unk22)
}
...
#ifdef NONMATCHING
void set_video2_settings_offset_24(s32 arg0) {
    // Node 0
    ptr_video_settings2->unk24 = arg0;
    return;
    // (function likely void)
}
...
#ifdef NONMATCHING
void video_related_1F(f32 arg0, f32 arg6) {
    // Node 0
    ptr_video_settings2->unk8 = arg6;
...
#ifdef NONMATCHING
void video_related_21(f32 arg0, f32 arg6) {
    // Node 0
    ptr_video_settings2->unkC = arg6;
    sub_GAME_7F077C30(ptr_video_settings2->unk10, ptr_video_settings2->unk8, ptr_video_settings2->unkC);
    sub_GAME_7F077C5C();
    return;
    // (possible return value: sub_GAME_7F077C5C())
...
void video_related_23(void) {
    // (possible return value: ptr_video_settings2->unk8)
}
...
#ifdef NONMATCHING
void video_related_24(f32 arg0, f32 arg1, f32 arg6, f32 arg7) {
    // Node 0
    ptr_video_settings2->unk8 = arg7;
    ptr_video_settings2->unkC = (f32) (arg6 / arg7);
    sub_GAME_7F077C30(ptr_video_settings2->unk10, ptr_video_settings2->unk8, ptr_video_settings2->unkC);
    sub_GAME_7F077C5C();
    return;
    // (possible return value: sub_GAME_7F077C5C())
...
#ifdef NONMATCHING
void set_page_height(f32 arg0, f32 arg1, f32 arg6, f32 arg7) {
    // Node 0
    ptr_video_settings2->unk10 = arg6;
    ptr_video_settings2->unk14 = arg7;
    sub_GAME_7F077C30(ptr_video_settings2->unk10, ptr_video_settings2->unk8, ptr_video_settings2->unkC);
    sub_GAME_7F077C5C();
    return;
    // (possible return value: sub_GAME_7F077C5C())
...
void *video_related_27(void *arg0) {
    // Node 0
    *arg0 = (f32) ptr_video_settings2->unk10;
...
/* 00556C 7000496C 3C05803B */  lui   $a1, %hi(vid_buff_1) # $a1, 0x803b
/* 005570 70004970 24A55000 */  addiu $a1, %lo(vid_buff_1) # addiu $a1, $a1, 0x5000
...
/* 00584C 70004C4C 3C05803B */  lui   $a1, %hi(vid_buff_1) # $a1, 0x803b
/* 005850 70004C50 24A55000 */  addiu $a1, %lo(vid_buff_1) # addiu $a1, $a1, 0x5000
