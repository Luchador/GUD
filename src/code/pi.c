...
void start_pi_manager(void) {
    // Node 0
    osCreatePiManager(0x96, &dword_CODE_bss_80064ED0, &dword_CODE_bss_80064EB0, 8);
    return;
    // (possible return value: osCreatePiManager(0x96, &dword_CODE_bss_80064ED0, &dword_CODE_bss_80064EB0, 8))
}
