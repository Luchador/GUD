...
typedef enum CREDITS_STATE
{
    CREDIT_STATE_START,
    CREDITS_STATE_ROLLING,
    CREDITS_STATE_COMPLETED,
    CREDITS_STATE_DIALOGUE,
    CREDITS_STATE_SKIPPING
} CREDITS_STATE;
...
/* PROPDEF_TYPE is shared with asset tools through propconstants.h. */
#ifdef AIPARSE
