...
typedef enum DEBUG_OPTIONS {
    ...
    DEB_JOY2SKYEDIT = 69,
    DEB_JOY2HITSEDIT = 70,
    DEB_JOY2DETAILEDIT = 71,
    DEB_EXPLOSIONINFO = 72,
    DEB_MAGICFOG = 73,
    DEB_GUNWATCHPOS = 74,
    DEB_TESTINGMANPOS = 75,
    DEB_FOG = 76
} DEBUG_MODES;
...
typedef enum PROPDEF_TYPE
{
    ...
    PROPDEF_ARMOUR = 21,
    PROPDEF_TAG = 22,
    PROPDEF_OBJECTIVE_START = 23,
    PROPDEF_OBJECTIVE_END = 24,
...
typedef enum CHEAT_IDS {
    ...
    CHEAT_2X_ROCKET_LAUNCHER = 29,
    CHEAT_2X_GRENADE_LAUNCHER = 30,
    CHEAT_2X_RCP90 = 31,
    CHEAT_2X_THROWING_KNIFE = 32,
    CHEAT_2X_HUNTING_KNIFE = 33,
    CHEAT_2X_LASER = 34,
    
    CHEAT_UNUSED_0x23 = 0x23,
    CHEAT_UNUSED_0x24,
    CHEAT_UNUSED_0x25,
    CHEAT_UNUSED_0x26,
    CHEAT_UNUSED_0x27,
...
typedef enum MODELNODE_OPCODE {
    MODELNODE_OPCODE_HEADERRECORD = 1,
    MODELNODE_OPCODE_GROUPRECORD = 2,
    MODELNODE_OPCODE_UNUSED_03 = 3,
    MODELNODE_OPCODE_DISPLAYLISTRECORD = 4,
    MODELNODE_OPCODE_UNUSED_05 = 5,
    MODELNODE_OPCODE_UNUSED_06 = 6,
    MODELNODE_OPCODE_OP07RECORD = 7,
    MODELNODE_OPCODE_LODRECORD = 8,
    MODELNODE_OPCODE_BSPRECORD = 9,
    MODELNODE_OPCODE_BOUNDINGBOXRECORD = 10,
    MODELNODE_OPCODE_OP11RECORD = 11,
    MODELNODE_OPCODE_GUNFIRERECORD = 12,
    MODELNODE_OPCODE_SHADOWRECORD = 13,
    MODELNODE_OPCODE_OP14RECORD = 14,
    MODELNODE_OPCODE_INTERLINKAGERECORD = 15,
    MODELNODE_OPCODE_OP16RECORD = 16,
    MODELNODE_OPCODE_UNUSED_17 = 17,
    MODELNODE_OPCODE_SWITCHRECORD = 18,
    MODELNODE_OPCODE_UNUSED_19 = 19,
    MODELNODE_OPCODE_UNUSED_20 = 20,
    MODELNODE_OPCODE_GROUPSIMPLERECORD = 21,
    MODELNODE_OPCODE_DISPLAYLISTPRIMARYRECORD = 22,
...
#define GUNFILERECORD(NAME, NOMODEL, STATS, UPPERTEXTID, LOWERTEXTID, POSX, POSY, POSZ, XROT, YROT, WOCTEXT, EQUIPTEXT, EQUIPX, EQUIPY, EQUIPZ) { &NAME ## _header,STR(G## NAME ##Z), NOMODEL, STATS, UPPERTEXTID, LOWERTEXTID, POSX, POSY, POSZ, XROT, YROT, WOCTEXT, EQUIPTEXT, EQUIPX, EQUIPY, EQUIPZ},
#define SUIT_LFRECORD(NAME, NOMODEL, STATS, UPPERTEXTID, LOWERTEXTID, POSX, POSY, POSZ, XROT, YROT, WOCTEXT, EQUIPTEXT, EQUIPX, EQUIPY, EQUIPZ) { &NAME ## _header,STR(C## NAME ##Z), NOMODEL, STATS, UPPERTEXTID, LOWERTEXTID, POSX, POSY, POSZ, XROT, YROT, WOCTEXT, EQUIPTEXT, EQUIPX, EQUIPY, EQUIPZ},
