...
typedef enum SFX_ID
{
    ...
    KNIFE_HIT_WALL_SFX,
    MINE_THROW_SFX,
    MINE_THROW_QUIET_SFX,
    MINE_THROW_FAINT_SFX,
    ELEVATOR_DING_SFX,
    TRAIN_RAILS1_SFX,
    TRAIN_RAILS2_SFX,
    WATCH_INTERFERENCE_SFX,
    TANK_CANNON_SFX,
    GRENADE_LAUNCHER_SFX,
    GET_HIT_GIRL1_SFX,
    GET_HIT_GIRL2_SFX,
    GET_HIT_GIRL3_SFX,
    BEEP_SFX,
    ...
    DOOR_HYDRAL_LOOP_SFX,
    DOOR_HYDRAL_STOP_SFX,
    HIT_BULLET_DIRT1_SFX,
    HIT_METAL_OBJECT2_SFX,
    BUTTON_PRESS_SFX,
    TRAIN_CLUTTER2_SFX,
    HIT_BULLET_MUD3_SFX,
    DOOR_SLIDE_STONE_LOOP_SFX,
    DOOR_SLIDE_STONE_STOP_SFX,
    DATA_DOWNLOAD_SFX,
    LASER_GUN_SFX,
    KEYCARD_SFX,
    HIT_BULLET_MUD2_SFX,
    ...
    char *SFX_ID_ToString[] = {
        ...
        "4_MINE_THROW_SFX",
        "5_MINE_THROW_QUIET_SFX",
        "6_MINE_THROW_FAINT_SFX",
        "7_ELEVATOR_DING_SFX",
        "8_TRAIN_RAILS_SFX",
        "9_TRAIN_RAILS2_SFX",
        "10_WATCH_INTERFERENCE_SFX",
        "11_TANK_CANNON_SFX",
        "12_GRENADE_LAUNCHER_SFX",
        ...
        "52_TRAIN_CLUTTER2_SFX",
        "53_TRAIN_CLUTTER1_SFX",
        "55_EVIL_LAUGH_SFX",
        "56_EVIL_LAUGH_QUIET_SFX",
        "57_EVIL_LAUGH_FAINT_SFX",
        ...
        "109_GUN_KF7_SFX",
        "110_GUN_UNKNOWN_SFX",
        "111_GUN_REVOLVER_SFX",
        "112_GUN_DD44_SFX",
        "113_GUN_AR33_SFX",
        "114_GUN_GRENADE_LAUNCHER_SFX",
        "115_GUN_UNKNOWN_SFX",
        "116_GUN_AUTOSHOTGUN_SFX",
        "117_GUN_GOLDENGUN_SFX",
        ...
        "218_DOOR_HYDRAL_LOOP_SFX",
        "219_DOOR_HYDRAL_STOP_SFX",
        "220_HIT_BULLET_DIRT1_SFX",
        "221_HIT_METAL_OBJECT2_SFX",
        "222_BUTTON_PRESS_SFX",
        "223_TRAIN_CLUTTER2_SFX",
        "224_HIT_BULLET_MUD3_SFX",
        "225_DOOR_SLIDE_STONE_LOOP_SFX",
        "226_DOOR_SLIDE_STONE_STOP_SFX",
        ...
        "243_WATCH_DETONATE_MINE_SFX",
        "244_CAMERA_SHUTTER_SFX",
        "245_KEY_ANALYSER_SFX",
        "246_MAGNETIC_HUM_SFX",
        "247_BOMB_DEFUSE_SFX",
        "248_BI_PLANE_SFX",
        "249_TRAIN_CLUTTER_SFX",
        "250_TRAIN_CLUTTER_SFX",
        "251_TRAIN_CLUTTER_SFX",
        "252_TRAIN_CLUTTER_SFX",
        "253_GUN_AUTOGUN_RCP90_SFX",
