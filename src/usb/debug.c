...
#include "PR/R4300.h"
    ...
    *********************************/
        ...
        // Other
            ...
            static void* debug_rmonPrintf_implementation(void *unused, const char *str, size_t len);
        #endif
    #else
        static void debug_thread_usb(void *arg);
    #endif
    ...
    *********************************/
    ...
    void debug_initialize()
    {
        ...
        // Overwrite rmonPrintf
        #ifndef LIBDRAGON
            #if OVERWRITE_OSPRINT
                __printfunc = (void*)debug_rmonPrintf_implementation;
            #endif
    ...
    static void debug_thread_usb(void *arg)
    {
        ...
        while (1)
        {
            ...
            /*==============================
                debug_rmonPrintf_implementation
                Overwrites rmonPrintf calls with this one
                @param Unused
