...
#ifdef NONMATCHING
void osCreateThread(s32 arg0, s32 arg1, ? arg2, ? arg3, void *argA, ?32 argB, ?32 argC, s32 argD, u32 argE, ?32 argF) {
    s32 sp20;
    ...
    *argA = 0;
    argA->unk8 = 0;
    argA->unk11C = argC;
    argA->unk38 = (s32) (argD >> 0x1f);
    argA->unk3C = argD;
    argA->unkF4 = (s32) (argE + -0x10);
    argA->unkF0 = (s32) ((argE >> 0x1f) - (argE < 0x10U));
    argA->unk100 = (s32) (&__osCleanupThread >> 0x1f);
    argA->unk104 = &__osCleanupThread;
    sp20 = 0x3fff01;
    argA->unk118 = 0xff03;
    argA->unk128 = (u32) ((u32) (sp20 & 0x3f0000) >> 0x10);
    argA->unk12C = 0x1000800;
    argA->unk18 = 0;
    argA->unk10 = (u16)1;
    argA->unk12 = (u16)0;
    argA->unkC = (void *) __osActiveQueue;
    __osActiveQueue = argA;
...
/* 00E138 7000D538 3C0A8002 */  lui   $t2, %hi(__osActiveQueue) # $t2, 0x8002
...
/* 00E148 7000D548 3C018002 */  lui   $at, %hi(__osActiveQueue) # $at, 0x8002
