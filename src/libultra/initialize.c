...
s32 __osShutdown = 0;
OSIntMask __OSGlobalIntMask = 0x3FFF01;
u32 osDiskExist = 0;
...
void osInitialize(void) {
    ...
    if (__osSiRawReadIo(0x1fc007fc, &sp3C) != 0)
    {
        loop_1:
        // Node 1
        if (__osSiRawReadIo(0x1fc007fc, &sp3C) != 0)
    ...
    // Node 2
    if (__osSiRawWriteIo(0x1fc007fc, (sp3C | 8)) != 0)
    {
        loop_3:
        // Node 3
        if (__osSiRawWriteIo(0x1fc007fc, (sp3C | 8)) != 0)
    ...
    // Node 4
    *(void *)0x80000000 = (?32) __osExceptionPreamble;
    (void *)0x80000000->unk4 = (?32) __osExceptionPreamble.unk4;
    (void *)0x80000000->unk8 = (?32) __osExceptionPreamble.unk8;
    (void *)0x80000000->unkC = (?32) __osExceptionPreamble.unkC;
    *0x80000080 = (?32) __osExceptionPreamble;
    0x80000080->unk4 = (?32) __osExceptionPreamble.unk4;
    0x80000080->unk8 = (?32) __osExceptionPreamble.unk8;
    0x80000080->unkC = (?32) __osExceptionPreamble.unkC;
    *0x80000100 = (?32) __osExceptionPreamble;
    0x80000100->unk4 = (?32) __osExceptionPreamble.unk4;
    0x80000100->unk8 = (?32) __osExceptionPreamble.unk8;
    0x80000100->unkC = (?32) __osExceptionPreamble.unkC;
    *0x80000180 = (?32) __osExceptionPreamble;
    0x80000180->unk4 = (?32) __osExceptionPreamble.unk4;
    0x80000180->unk8 = (?32) __osExceptionPreamble.unk8;
    0x80000180->unkC = (?32) __osExceptionPreamble.unkC;
    ...
    // Node 6
    temp_ret = __ll_mul(osClockRate, osClockRate, 0, 3);
    sp20 = temp_ret;
    sp24 = temp_ret;
    temp_ret_2 = ull_div(sp20, sp24, 0, 4);
    osClockRate = temp_ret_2;
    osClockRate = temp_ret_2;
    if (osResetType == 0)
    {
        // Node 7
        _blkclr(&osAppNMIBuffer, 0x40);
    }
    // Node 8
    sp30 = (s32) PI_STATUS_REG;
    ...
    // Node 10
    sp34 = (s32) ASIC_STATUS;
    if ((ASIC_STATUS & 0xffff) == 0)
    {
        // Node 11
        osDiskExist = 1;
        __osSetHWIntrRoutine(1, &__osLeoInterrupt);
        return;
        // (possible return value: __osSetHWIntrRoutine(1, &__osLeoInterrupt))
    }
    // Node 12
    osDiskExist = 0;
    return;
    // (possible return value: temp_ret_2)
}
#else
GLOBAL_ASM(
.text
...
/* 00DC8C 7000D08C 3C018006 */  lui   $at, %hi(__osFinalRom) # $at, 0x8006
...
/* 00DE28 7000D228 3C018002 */  lui   $at, %hi(osClockRate) # $at, 0x8002
...
/* 00DEE4 7000D2E4 3C018002 */  lui   $at, %hi(osDiskExist) # $at, 0x8002
...
.L7000D304:
/* 00DF04 7000D304 3C018002 */  lui   $at, %hi(osDiskExist) # $at, 0x8002
