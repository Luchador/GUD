...
#ifdef NONMATCHING
void osPiRawStartDma(s32 arg0, s32 arg1, ? arg2, ? arg3, s32 argA, s32 argB, ? argC, s32 argD) {
    // Node 0
    if ((PI_STATUS_REG & 3) != 0)
    {
        loop_1:
        // Node 1
        if ((PI_STATUS_REG & 3) != 0)
    ...
    // Node 2
    *(void *)0xa4600000 = osVirtualToPhysical(argC);
    PI_CART_ADDR_REG = (s32) ((osRomBase | argB) & 0x1fffffff);
    if (argA != 0)
    {
        // Node 3
        if (argA != 1)
        ...
        // Node 6
        PI_RD_LEN_REG = (s32) (argD + -1);
    }
    else
    {
        // Node 5
        PI_WR_LEN_REG = (s32) (argD + -1);
    }
    // Node 8
    return;
