...
#ifdef NONMATCHING
void osStartThread(s32 arg0, void *argA) {
    // Node 0
    if (argA->unk10 != 8)
    {
        // Node 1
        if (argA->unk10 == 8)
        {
            // Node 2
            argA->unk10 = (u16)2;
            __osEnqueueThread(&__osRunQueue, argA);
        }
    }
    else
    {
        // Node 3
        if ((argA->unk8 == 0) || (argA->unk8 == &__osRunQueue))
        {
            // Node 5
            argA->unk10 = (u16)2;
            __osEnqueueThread(&__osRunQueue, argA);
        ...
        else
        {
            ...
            __osEnqueueThread(&__osRunQueue, __osPopThread(argA->unk8));
        }
    }
    // Node 7
...
/* 00E1C0 7000D5C0 3C048002 */  lui   $a0, %hi(__osRunQueue) # $a0, 0x8002
...
/* 00E1EC 7000D5EC 3C098002 */  lui   $t1, %hi(__osRunQueue) # $t1, 0x8002
...
/* 00E204 7000D604 3C048002 */  lui   $a0, %hi(__osRunQueue) # $a0, 0x8002
...
/* 00E24C 7000D64C 3C048002 */  lui   $a0, %hi(__osRunQueue) # $a0, 0x8002
...
.L7000D65C:
/* 00E25C 7000D65C 3C188002 */  lui   $t8, %hi(__osRunningThread) # $t8, 0x8002
...
.L7000D67C:
/* 00E27C 7000D67C 3C198002 */  lui   $t9, %hi(__osRunningThread) # $t9, 0x8002
/* 00E280 7000D680 3C098002 */  lui   $t1, %hi(__osRunQueue) # $t1, 0x8002
...
/* 00E2A4 7000D6A4 3C048002 */  lui   $a0, %hi(__osRunQueue) # $a0, 0x8002
