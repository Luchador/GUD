...
//       spectrum of flags
//===========================================================================*/
#define guard_bitfield_if_set_on_ID 0x96
#define guard_bitfield_if_set_on_LENGTH 0x03
#define guard_bitfield_if_set_on(bitfield, label) \
        guard_bitfield_if_set_on_ID, \
        bitfield, \
        label,
...
/*=============================================================================
// name: chr_bitfield_if_set_on
// command id: 99
// info: if bits is set on in chr->BITFIELD, goto label
//===========================================================================*/
#define chr_bitfield_if_set_on_ID 0x99
#define chr_bitfield_if_set_on_LENGTH 0x04
#define chr_bitfield_if_set_on(chr_num, bitfield, label) \
        chr_bitfield_if_set_on_ID, \
        chr_num, \
        bitfield, \
        label,
...
/*=============================================================================
// name: objective_bitfield_if_set_on
// command id: 9C
// info: if bits in objective bitfield are set on, goto label
//=============================================================================
// note: can check multiple flags at once
//===========================================================================*/
#define objective_bitfield_if_set_on_ID 0x9C
#define objective_bitfield_if_set_on_LENGTH 0x06
#define objective_bitfield_if_set_on(bitfield, label) \
        objective_bitfield_if_set_on_ID, \
        chararray32(bitfield), \
        label,
...
// obj ai lists, obj lists are free to utilize the entire spectrum of flags
//===========================================================================*/
#define guard_flags_if_set_on_ID 0x9F
#define guard_flags_if_set_on_LENGTH 0x06
#define guard_flags_if_set_on(bitfield, label) \
        guard_flags_if_set_on_ID, \
        chararray32(bitfield), \
        label,
...
// by many parts of the engine. bitfield uses CHRFLAG_# defines
//===========================================================================*/
#define chr_flags_if_set_on_ID 0xA2
#define chr_flags_if_set_on_LENGTH 0x07
#define chr_flags_if_set_on(chr_num, bitfield, label) \
        chr_flags_if_set_on_ID, \
        chr_num, \
        chararray32(bitfield), \
        label,
