...
/* 035130 7F000600 3C110000 */  lui   $s1, %hi(D_00004018) # $s1, 0
/* 035134 7F000604 26314018 */  addiu $s1, %lo(D_00004018) # addiu $s1, $s1, 0x4018
...
/* 03518C 7F00065C 3C030000 */  lui   $v1, %hi(D_000040D4) # $v1, 0
/* 035190 7F000660 3C018003 */  lui   $at, %hi(D_80030984) # $at, 0x8003
/* 035194 7F000664 246340D4 */  addiu $v1, %lo(D_000040D4) # addiu $v1, $v1, 0x40d4
...
/* 0351F0 7F0006C0 3C110000 */  lui   $s1, %hi(D_00004070) # $s1, 0
/* 0351F4 7F0006C4 3C018003 */  lui   $at, %hi(D_80030988) # $at, 0x8003
/* 0351F8 7F0006C8 26314070 */  addiu $s1, %lo(D_00004070) # addiu $s1, $s1, 0x4070
...
/* 03524C 7F00071C 3C030001 */  lui   $v1, %hi(D_00008204) # $v1, 1
/* 035250 7F000720 3C018003 */  lui   $at, %hi(D_8003098C) # $at, 0x8003
/* 035254 7F000724 24638204 */  addiu $v1, %lo(D_00008204) # addiu $v1, $v1, -0x7dfc
...
/* 0352B0 7F000780 3C070000 */  lui   $a3, %hi(D_0000777C) # $a3, 0
/* 0352B4 7F000784 3C018003 */  lui   $at, %hi(D_80030990) # $at, 0x8003
/* 0352B8 7F000788 24E7777C */  addiu $a3, %lo(D_0000777C) # addiu $a3, $a3, 0x777c
...
/* 035314 7F0007E4 3C110000 */  lui   $s1, %hi(D_000077D4) # $s1, 0
/* 035318 7F0007E8 3C018003 */  lui   $at, %hi(D_80030994) # $at, 0x8003
/* 03531C 7F0007EC 263177D4 */  addiu $s1, %lo(D_000077D4) # addiu $s1, $s1, 0x77d4
...
/* 035370 7F000840 3C030001 */  lui   $v1, %hi(D_000084C4) # $v1, 1
/* 035374 7F000844 3C018003 */  lui   $at, %hi(D_80030998) # $at, 0x8003
/* 035378 7F000848 246384C4 */  addiu $v1, %lo(D_000084C4) # addiu $v1, $v1, -0x7b3c
...
/* 0353D4 7F0008A4 3C070001 */  lui   $a3, %hi(D_00008520) # $a3, 1
/* 0353D8 7F0008A8 3C018003 */  lui   $at, %hi(D_8003099C) # $at, 0x8003
/* 0353DC 7F0008AC 24E78520 */  addiu $a3, %lo(D_00008520) # addiu $a3, $a3, -0x7ae0
