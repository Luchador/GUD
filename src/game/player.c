 ...
 */
    ...
    g_playerPointers[player_num]->worldToViewMtxf = NULL;
    ...
    g_playerPointers[player_num]->lookAt = NULL;
    g_playerPointers[player_num]->previousWorldToViewMtxf = NULL;
    g_playerPointers[player_num]->previousViewToWorldMtxf = NULL;
