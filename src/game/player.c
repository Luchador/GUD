...
void initBONDdataforPlayer(s32 player_num)
{
    ...
    g_playerPointers[player_num]->lookahead_auto_adjust_pitch_active = FALSE;
    g_playerPointers[player_num]->field_108 = 0;
    g_playerPointers[player_num]->manual_adjust_pitch_active = 0;
    g_playerPointers[player_num]->suppress_move_centre_until_walk_release = FALSE;
    g_playerPointers[player_num]->lookahead_enable_stan_test = TRUE;
    g_playerPointers[player_num]->lookaheadenabled = TRUE;
    g_playerPointers[player_num]->fastmovecentreenabled = FALSE;
    g_playerPointers[player_num]->lookahead_auto_centre_armed = TRUE;
