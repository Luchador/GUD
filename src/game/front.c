...
struct mp_stage_setup multi_stage_setups[] = {
  ...
  //{getStringID(LTITLE, TITLE_STR_123_RUN), getStringID(LTITLE, TITLE_STR_123_RUN), IMG_MP_RUNWAY, LEVELID_RUNWAY, -1, 1, 4}, //runway (xbla setup)
  //{getStringID(LTITLE, TITLE_STR_121_DAM), getStringID(LTITLE, TITLE_STR_121_DAM), IMG_MP_DAM, LEVELID_DAM, -1, 1, 4}, //dam (xbla setup)
};
