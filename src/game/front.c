...
Gfx *frontDrawCursor(Gfx *DL)
{
    ...
    insertImageIntoDL(&DL, image, 4, 0, 0);
...
Gfx *constructor_menu05_fileselect(Gfx *DL)
{
    ...
    if(1)
    {
        ...
        insertImageIntoDL(&DL, mainfolderimages, 4, 0, 0);
        ...
        insertImageIntoDL(&DL, mainfolderimages + IMG_DEL, 4, 0, 0);
        ...
        insertImageIntoDL(&DL, mainfolderimages + IMG_SEL, 4, 0, 0);
...
Gfx * constructor_menu12_mpstage(Gfx *DL)
{
    ...
    insertImageIntoDL(&DL, simage, 1, 0, 2); // IMAGE_DOT
    ...
    for (spB4 = 0; spB4 != 3; spB4++)
    {
        ...
        for (i_3 = 0; i_3 < 4; i_3++)
        {
            if (count < 12)
            {
                ...
                insertImageIntoDL(&DL, simage, 1, 0, 2);
