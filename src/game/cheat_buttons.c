...
struct struct_15 D_8003F80C[] = {
    {0x01, 0xA, 0, 0, dword_D_8003F430,          0, 0x31},
    {0x02, 0xA, 0, 0, dword_D_8003F444, 0xB0000000,    6},
    {0x03, 0xA, 0, 0, dword_D_8003F458, 0xB0010000,    2},
    {0x04, 0xA, 0, 0, dword_D_8003F46C,          0, 0x16},
    {0x05, 0xA, 0, 0, dword_D_8003F480,          0, 0x16},
    {0x06, 0xA, 0, 0, dword_D_8003F494,          0, 0x34},
    {0x07, 0xA, 0, 0, dword_D_8003F4A8, 0xB0370000, 0x66},
    {0x08,   0, 0, 0,                0,          0, 0x16},
    {0x09,   0, 0, 0,                0,          0, 0x16},
    {0x0A, 0xA, 0, 0, dword_D_8003F4BC, 0xB0040000, 0x62},
    {0x0B,   0, 0, 0,                0, 0xB0060000, 0x66},
    {0x0C,   0, 0, 0,                0, 0xB0070000, 0x26},
    {0x0D,   0, 0, 0,                0,          0, 0x12},
    {0x0E,   0, 0, 0,                0, 0xB0080000,    2},
    {0x0F,   0, 0, 0,                0, 0xB0380000, 0x66},
    {0x10,   0, 0, 0,                0,          0, 0x16},
...
/* 0C70E8 7F0925B8 3C188008 */   lui   $t8, %hi(g_playerPerm)
/* 0C70EC 7F0925BC 8F18A0B4 */  lw    $t8, %lo(g_playerPerm)($t8)
...
/* 0C7120 7F0925F0 3C198008 */  lui   $t9, %hi(g_playerPerm)
/* 0C7124 7F0925F4 8F39A0B4 */  lw    $t9, %lo(g_playerPerm)($t9)
/* 0C7128 7F0925F8 44814000 */  mtc1  $at, $f8
/* 0C712C 7F0925FC 3C088008 */  lui   $t0, %hi(g_CurrentPlayer)
/* 0C7130 7F092600 E7280064 */  swc1  $f8, 0x64($t9)
/* 0C7134 7F092604 8D08A0B0 */  lw    $t0, %lo(g_CurrentPlayer)($t0)
