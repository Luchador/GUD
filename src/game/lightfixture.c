...
Vtx * return_ptr_vertex_of_entry_room(Gfx * gfx, s32 room_index)
{
    ...
    if (((s32) ret & 0xFF000000) == 0x0E000000) {
        ret = (s32)roominf[room_index].ptr_point_index + ((s32) ret & 0xFFFFFF);
    }
...
void redarken_lights_in_room(s32 room_index)
{
    ...
    vertex = roominf[room_index].ptr_point_index;
...
void darken_vertex_in_room(Vtx * vertex, s32 room_index)
{
    ...
    vtx_index = ((u32)vertex - (u32)roominf[room_index].ptr_point_index) >> 4;
...
s32 sub_GAME_7F0BBCCC(coord16 * coord, s32 room_index)
{
    ...
    do
    {
        ...
        {
            vertex = &roominf[room_index].ptr_point_index[darkened_light_table[i].vtx_index];
