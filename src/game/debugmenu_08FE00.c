...
/* 0C4944 7F08FE14 3C018003 */  lui   $at, %hi(D_80036B78) # $at, 0x8003
/* 0C4948 7F08FE18 AC246B78 */  sw    $a0, %lo(D_80036B78)($at)
/* 0C494C 7F08FE1C 3C018003 */  lui   $at, %hi(D_80036B7C) # $at, 0x8003
/* 0C4950 7F08FE20 AC256B7C */  sw    $a1, %lo(D_80036B7C)($at)
/* 0C4954 7F08FE24 3C018003 */  lui   $at, %hi(D_80036B84) # $at, 0x8003
/* 0C4958 7F08FE28 AC266B84 */  sw    $a2, %lo(D_80036B84)($at)
...
/* 0C4990 7F08FE60 3C018003 */  lui   $at, %hi(D_80036B74) # $at, 0x8003
/* 0C4994 7F08FE64 AC286B74 */  sw    $t0, %lo(D_80036B74)($at)
/* 0C4998 7F08FE68 3C018003 */  lui   $at, 0x8003
...
/* 0C49B0 7F08FE80 3C0E8003 */  lui   $t6, %hi(D_80036B74) # $t6, 0x8003
/* 0C49B4 7F08FE84 8DCE6B74 */  lw    $t6, %lo(D_80036B74)($t6)
/* 0C49B8 7F08FE88 AFBE0038 */  sw    $fp, 0x38($sp)
/* 0C49BC 7F08FE8C AFB70034 */  sw    $s7, 0x34($sp)
/* 0C49C0 7F08FE90 3C178003 */  lui   $s7, 0x8003
/* 0C49C4 7F08FE94 3C1E8003 */  lui   $fp, 0x8003
...
/* 0C49F4 7F08FEC4 92F76B8C */  lbu   $s7, 0x6b8c($s7)
/* 0C49F8 7F08FEC8 93DE6B90 */  lbu   $fp, 0x6b90($fp)
/* 0C49FC 7F08FECC 19C00042 */  blez  $t6, .L7F08FFD8
/* 0C4A00 7F08FED0 00008025 */   move  $s0, $zero
/* 0C4A04 7F08FED4 3C168003 */  lui   $s6, %hi(D_80036B78) # $s6, 0x8003
/* 0C4A08 7F08FED8 3C148003 */  lui   $s4, %hi(D_80036B7C) # $s4, 0x8003
/* 0C4A0C 7F08FEDC 3C138003 */  lui   $s3, %hi(D_80036B70) # $s3, 0x8003
/* 0C4A10 7F08FEE0 26736B70 */  addiu $s3, %lo(D_80036B70) # addiu $s3, $s3, 0x6b70
/* 0C4A14 7F08FEE4 26946B7C */  addiu $s4, %lo(D_80036B7C) # addiu $s4, $s4, 0x6b7c
/* 0C4A18 7F08FEE8 26D66B78 */  addiu $s6, %lo(D_80036B78) # addiu $s6, $s6, 0x6b78
...
/* 0C4AEC 7F08FFBC 3C0E8003 */  lui   $t6, %hi(D_80036B74) # $t6, 0x8003
/* 0C4AF0 7F08FFC0 8DCE6B74 */  lw    $t6, %lo(D_80036B74)($t6)
...
/* 0C4B44 7F090014 3C028003 */  lui   $v0, %hi(D_80036B88) # $v0, 0x8003
/* 0C4B48 7F090018 8C426B88 */  lw    $v0, %lo(D_80036B88)($v0)
/* 0C4B4C 7F09001C 3C158003 */  lui   $s5, %hi(D_80036B74) # $s5, 0x8003
/* 0C4B50 7F090020 26B56B74 */  addiu $s5, %lo(D_80036B74) # addiu $s5, $s5, 0x6b74
/* 0C4B54 7F090024 8EAE0000 */  lw    $t6, ($s5)
/* 0C4B58 7F090028 AFB40028 */  sw    $s4, 0x28($sp)
/* 0C4B5C 7F09002C AFB30024 */  sw    $s3, 0x24($sp)
/* 0C4B60 7F090030 3C138003 */  lui   $s3, 0x8003
/* 0C4B64 7F090034 3C148003 */  lui   $s4, 0x8003
...
/* 0C4B98 7F090068 92736B8C */  lbu   $s3, 0x6b8c($s3)
/* 0C4B9C 7F09006C 92946B90 */  lbu   $s4, 0x6b90($s4)
/* 0C4BA0 7F090070 19C00043 */  blez  $t6, .L7F090180
/* 0C4BA4 7F090074 00008025 */   move  $s0, $zero
/* 0C4BA8 7F090078 3C178003 */  lui   $s7, %hi(D_80036B7C) # $s7, 0x8003
/* 0C4BAC 7F09007C 3C168003 */  lui   $s6, %hi(D_80036B70) # $s6, 0x8003
/* 0C4BB0 7F090080 26D66B70 */  addiu $s6, %lo(D_80036B70) # addiu $s6, $s6, 0x6b70
/* 0C4BB4 7F090084 26F76B7C */  addiu $s7, %lo(D_80036B7C) # addiu $s7, $s7, 0x6b7c
...
/* 0C4C78 7F090148 3C0C8003 */  lui   $t4, %hi(D_80036B78) # $t4, 0x8003
/* 0C4C7C 7F09014C 8D8C6B78 */  lw    $t4, %lo(D_80036B78)($t4)
...
/* 0C4CF8 7F0901C8 3C068003 */  lui   $a2, %hi(D_80036B70) # $a2, 0x8003
/* 0C4CFC 7F0901CC 24C66B70 */  addiu $a2, %lo(D_80036B70) # addiu $a2, $a2, 0x6b70
/* 0C4D00 7F0901D0 8CCE0000 */  lw    $t6, ($a2)
/* 0C4D04 7F0901D4 3C188003 */  lui   $t8, %hi(D_80036B84) # $t8, 0x8003
/* 0C4D08 7F0901D8 3C048003 */  lui   $a0, 0x8003
/* 0C4D0C 7F0901DC 25C2FFFF */  addiu $v0, $t6, -1
/* 0C4D10 7F0901E0 04410006 */  bgez  $v0, .L7F0901FC
/* 0C4D14 7F0901E4 ACC20000 */   sw    $v0, ($a2)
/* 0C4D18 7F0901E8 8F186B84 */  lw    $t8, %lo(D_80036B84)($t8)
...
.L7F0901FC:
/* 0C4D2C 7F0901FC 8C846B80 */  lw    $a0, 0x6b80($a0)
/* 0C4D30 7F090200 00001825 */  move  $v1, $zero
/* 0C4D34 7F090204 3C058003 */  lui   $a1, %hi(D_80036B84) # $a1, 0x8003
/* 0C4D38 7F090208 1880000D */  blez  $a0, .L7F090240
/* 0C4D3C 7F09020C 00000000 */   nop   
/* 0C4D40 7F090210 8CA56B84 */  lw    $a1, %lo(D_80036B84)($a1)
.L7F090214:
...
/* 0C4D78 7F090248 3C078003 */  lui   $a3, %hi(D_80036B70) # $a3, 0x8003
/* 0C4D7C 7F09024C 24E76B70 */  addiu $a3, %lo(D_80036B70) # addiu $a3, $a3, 0x6b70
/* 0C4D80 7F090250 8CEE0000 */  lw    $t6, ($a3)
/* 0C4D84 7F090254 3C038003 */  lui   $v1, %hi(D_80036B84) # $v1, 0x8003
/* 0C4D88 7F090258 3C058003 */  lui   $a1, 0x8003
/* 0C4D8C 7F09025C 25C20001 */  addiu $v0, $t6, 1
/* 0C4D90 7F090260 ACE20000 */  sw    $v0, ($a3)
/* 0C4D94 7F090264 8C636B84 */  lw    $v1, %lo(D_80036B84)($v1)
...
.L7F09027C:
/* 0C4DAC 7F09027C 8CA56B80 */  lw    $a1, 0x6b80($a1)
...
/* 0C4DF0 7F0902C0 3C038003 */  lui   $v1, %hi(D_80036B84) # $v1, 0x8003
/* 0C4DF4 7F0902C4 8C636B84 */  lw    $v1, %lo(D_80036B84)($v1)
/* 0C4DF8 7F0902C8 3C088003 */  lui   $t0, %hi(D_80036B70) # $t0, 0x8003
/* 0C4DFC 7F0902CC 25086B70 */  addiu $t0, %lo(D_80036B70) # addiu $t0, $t0, 0x6b70
/* 0C4E00 7F0902D0 8D020000 */  lw    $v0, ($t0)
/* 0C4E04 7F0902D4 8C640000 */  lw    $a0, ($v1)
/* 0C4E08 7F0902D8 3C058003 */  lui   $a1, 0x8003
...
.L7F090304:
/* 0C4E34 7F090304 8CA56B80 */  lw    $a1, 0x6b80($a1)
...
/* 0C4ECC 7F09039C 3C038003 */  lui   $v1, %hi(D_80036B84) # $v1, 0x8003
/* 0C4ED0 7F0903A0 8C636B84 */  lw    $v1, %lo(D_80036B84)($v1)
/* 0C4ED4 7F0903A4 3C078003 */  lui   $a3, %hi(D_80036B70) # $a3, 0x8003
/* 0C4ED8 7F0903A8 24E76B70 */  addiu $a3, %lo(D_80036B70) # addiu $a3, $a3, 0x6b70
/* 0C4EDC 7F0903AC 8CE20000 */  lw    $v0, ($a3)
/* 0C4EE0 7F0903B0 8C640000 */  lw    $a0, ($v1)
/* 0C4EE4 7F0903B4 3C058003 */  lui   $a1, %hi(D_80036B80) # $a1, 0x8003
...
/* 0C4EF4 7F0903C4 8CA56B80 */  lw    $a1, %lo(D_80036B80)($a1)
