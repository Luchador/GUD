...
.L7F06E29C:
/* 0A2DCC 7F06E29C 0FC1B62C */  jal   modelBuildGroupMatrices
        ...
        do {
            ...
            */
            ...
            case MODELNODE_OPCODE_BBOX - 1:
                if (sub_GAME_7F074C68(model, node, arg1, arg2) != 0) {
                    *nodeptr = node;
