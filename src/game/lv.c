...
/*  levelID;            levelName                setupFileName;               bg_seg_filename;        bg_stan_filename;      memoryAllocationString;                      levelscale;  renderScale;    main track;      bg_sound;     xtrack;  */
    ...
    {LEVELID_SHO,       "SHO",                   "UsetupshoZ",               "bg/bg_sho_all_p.seg",  "Tbg_sho_all_p_stanZ", NULL                                        ,  0.528,       1.0,            M_SURFACE2,      0xFFFF,       0xFFFF             },
    ...
    {LEVELID_ELD,       "ELD",                   "UsetupeldZ",               "bg/bg_eld_all_p.seg",  "Tbg_eld_all_p_stanZ", NULL                                        ,  0.94285715,  1.0,            0xFFFF,          0xFFFF,       0xFFFF             },
    ...
    {LEVELID_LUE,       "LUE",                   "UsetuplueZ",               "bg/bg_lue_all_p.seg",  "Tbg_lue_all_p_stanZ", NULL                                        ,  0.94285715,  1.0,            0xFFFF,          0xFFFF,       0xFFFF             },
    ...
    {LEVELID_RIT,       "RIT",                   "UsetupritZ",               "bg/bg_rit_all_p.seg",  "Tbg_rit_all_p_stanZ", NULL                                        ,  0.94285715,  1.0,            0xFFFF,          0xFFFF,       0xFFFF             },
    ...
    {LEVELID_EAR,       "EAR",                   "UsetupearZ",               "bg/bg_ear_all_p.seg",  "Tbg_ear_all_p_stanZ", NULL                                        ,  0.94285715,  1.0,            0xFFFF,          0xFFFF,       0xFFFF             },
    {LEVELID_LEE,       "LEE",                   "UsetupleeZ",               "bg/bg_lee_all_p.seg",  "Tbg_lee_all_p_stanZ", NULL                                        ,  0.94285715,  1.0,            0xFFFF,          0xFFFF,       0xFFFF             },
    {LEVELID_LIP,       "LIP",                   "UsetuplipZ",               "bg/bg_lip_all_p.seg",  "Tbg_lip_all_p_stanZ", NULL                                        ,  0.94285715,  1.0,            0xFFFF,          0xFFFF,       0xFFFF             },
