...
/*  levelID;           setupFileName;               bg_seg_filename;        bg_stan_filename;      levelscale;  visibility; */
    ...
    {LEVELID_CONTROL,  "UsetupcontrolZ",           "bg/bg_arec_all_p.seg", "Tbg_arec_all_p_stanZ", 0.49886572,  1.0},
    {LEVELID_ARCHIVES, "UsetuparchZ",              "bg/bg_arch_all_p.seg", "Tbg_arch_all_p_stanZ", 0.50678575,  1.0},
    {LEVELID_TRAIN,    "UsetuptraZ",               "bg/bg_tra_all_p.seg",  "Tbg_tra_all_p_stanZ",  0.15019713,  1.0},
    {LEVELID_FRIGATE,  "UsetupdestZ",              "bg/bg_dest_all_p.seg", "Tbg_dest_all_p_stanZ", 0.44757429,  1.0},
    {LEVELID_BUNKER2,  "UsetupsevbZ",              "bg/bg_sevb_all_p.seg", "Tbg_sevb_all_p_stanZ", 0.53931433,  1.0},
    {LEVELID_AZTEC,    "UsetupaztZ",               "bg/bg_azt_all_p.seg",  "Tbg_azt_all_p_stanZ",  0.35300568,  1.0},
    {LEVELID_STREETS,  "UsetuppeteZ",              "bg/bg_pete_all_p.seg", "Tbg_pete_all_p_stanZ", 0.34187999,  1.0},
    {LEVELID_DEPOT,    "UsetupdepoZ",              "bg/bg_depo_all_p.seg", "Tbg_depo_all_p_stanZ", 0.21847887,  1.0},
    {LEVELID_COMPLEX,  "UsetuprefZ",               "bg/bg_ref_all_p.seg",  "Tbg_ref_all_p_stanZ",  0.94285715,  1.0},
    {LEVELID_EGYPT,    "UsetupcrypZ",              "bg/bg_cryp_all_p.seg", "Tbg_cryp_all_p_stanZ", 0.25608,     1.0},
    {LEVELID_DAM,      "UsetupdamZ",               "bg/bg_dam_all_p.seg",  "Tbg_dam_all_p_stanZ",  0.23363999,  0.2},
    {LEVELID_FACILITY, "UsetuparkZ",               "bg/bg_ark_all_p.seg",  "Tbg_ark_all_p_stanZ",  1.20648,     1.0},
    {LEVELID_RUNWAY,   "UsetuprunZ",               "bg/bg_run_all_p.seg",  "Tbg_run_all_p_stanZ",  0.089571431, 1.0},
    {LEVELID_SURFACE,  "UsetupsevxZ",              "bg/bg_sevx_all_p.seg", "Tbg_sevx_all_p_stanZ", 0.45445713,  0.2},
    {LEVELID_JUNGLE,   "UsetupjunZ",               "bg/bg_jun_all_p.seg",  "Tbg_jun_all_p_stanZ",  0.094662853, 1.0},
    {LEVELID_TEMPLE,   "UsetupdishZ",              "bg/bg_dish_all_p.seg", "Tbg_dish_all_p_stanZ", 0.47142857,  1.0},
    {LEVELID_CAVERNS,  "UsetupcaveZ",              "bg/bg_cave_all_p.seg", "Tbg_cave_all_p_stanZ", 0.26824287,  1.0},
    {LEVELID_CITADEL,  "UsetupcatZ",               "bg/bg_cat_all_p.seg",  "Tbg_cat_all_p_stanZ",  0.76852286,  1.0},
    {LEVELID_CRADLE,   "UsetupcradZ",              "bg/bg_crad_all_p.seg", "Tbg_crad_all_p_stanZ", 0.23571429,  1.0},
    {LEVELID_SHO,      "UsetupshoZ",               "bg/bg_sho_all_p.seg",  "Tbg_sho_all_p_stanZ",  0.528,       1.0},
    {LEVELID_SURFACE2, "UsetupsevxbZ",             "bg/bg_sevx_all_p.seg", "Tbg_sevx_all_p_stanZ", 0.45445713,  0.2},
    {LEVELID_ELD,      "UsetupeldZ",               "bg/bg_eld_all_p.seg",  "Tbg_eld_all_p_stanZ",  0.94285715,  1.0},
    {LEVELID_BASEMENT, "UsetupimpZ",               "bg/bg_ame_all_p.seg",  "Tbg_ame_all_p_stanZ",  0.65999997,  1.0},
    {LEVELID_STACK,    "UsetupashZ",               "bg/bg_ame_all_p.seg",  "Tbg_ame_all_p_stanZ",  0.65999997,  1.0},
    {LEVELID_LUE,      "UsetuplueZ",               "bg/bg_lue_all_p.seg",  "Tbg_lue_all_p_stanZ",  0.94285715,  1.0},
    {LEVELID_LIBRARY,  "UsetupameZ",               "bg/bg_ame_all_p.seg",  "Tbg_ame_all_p_stanZ",  0.65999997,  1.0},
    {LEVELID_RIT,      "UsetupritZ",               "bg/bg_rit_all_p.seg",  "Tbg_rit_all_p_stanZ",  0.94285715,  1.0},
    {LEVELID_CAVES,    "UsetupoatZ",               "bg/bg_oat_all_p.seg",  "Tbg_oat_all_p_stanZ",  0.14142857,  1.0},
    {LEVELID_EAR,      "UsetupearZ",               "bg/bg_ear_all_p.seg",  "Tbg_ear_all_p_stanZ",  0.94285715,  1.0},
    {LEVELID_LEE,      "UsetupleeZ",               "bg/bg_lee_all_p.seg",  "Tbg_lee_all_p_stanZ",  0.94285715,  1.0},
    {LEVELID_LIP,      "UsetuplipZ",               "bg/bg_lip_all_p.seg",  "Tbg_lip_all_p_stanZ",  0.94285715,  1.0},
