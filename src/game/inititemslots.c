...
/* 03AD20 7F0061F0 3C048008 */  lui   $a0, %hi(pPlayer) # $a0, 0x8008
...
/* 03AD8C 7F00625C 3C028008 */  lui   $v0, %hi(pPlayer) # $v0, 0x8008
...
/* 03ADD0 7F0062A0 3C0A8008 */  lui   $t2, %hi(pPlayer) # $t2, 0x8008
