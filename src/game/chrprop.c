...
void propsTick(void)
{
    ...
    u32 profMatrixHatSetupCycles;
    u32 profMatrixHatBuildCycles;
    u32 profMatrixHatTransformCycles;
    u32 profMatrixHatHitChainCycles;
    u32 profMatrixHatCalls;
    u32 profMatrixHatHitChainCalls;
    ...
    while (prop != NULL)
    {
        ...
        if (prop->type == PROP_TYPE_CHR)
        {
            // TEMP
            {
                ...
                profMatrixHatSetupCycles = g_ProfChrMatrixHatSetupCycles;
                profMatrixHatBuildCycles = g_ProfChrMatrixHatBuildCycles;
                profMatrixHatTransformCycles = g_ProfChrMatrixHatTransformCycles;
                profMatrixHatHitChainCycles = g_ProfChrMatrixHatHitChainCycles;
                profMatrixHatCalls = g_ProfChrMatrixHatCalls;
                profMatrixHatHitChainCalls = g_ProfChrMatrixHatHitChainCalls;
                ...
                if (profCycles > g_ProfChrSlowestCycles)
                {
                    ...
                    g_ProfChrSlowestMatrixHatSetupCycles = g_ProfChrMatrixHatSetupCycles - profMatrixHatSetupCycles;
                    g_ProfChrSlowestMatrixHatBuildCycles = g_ProfChrMatrixHatBuildCycles - profMatrixHatBuildCycles;
                    g_ProfChrSlowestMatrixHatTransformCycles = g_ProfChrMatrixHatTransformCycles - profMatrixHatTransformCycles;
                    g_ProfChrSlowestMatrixHatHitChainCycles = g_ProfChrMatrixHatHitChainCycles - profMatrixHatHitChainCycles;
                    g_ProfChrSlowestMatrixHatCalls = g_ProfChrMatrixHatCalls - profMatrixHatCalls;
                    g_ProfChrSlowestMatrixHatHitChainCalls = g_ProfChrMatrixHatHitChainCalls - profMatrixHatHitChainCalls;
