...
void propsTick(void)
{
    ...
    u32 profMatrixBuildParentCycles;
    u32 profMatrixBuildPrimaryCycles;
    u32 profMatrixBuildMatrix1Cycles;
    u32 profMatrixBuildMatrix2Cycles;
    u32 profMatrixBuildCalls;
    u32 profMatrixBuildParentLookupCalls;
    u32 profMatrixBuildParentPresentCalls;
    u32 profMatrixBuildMatrix1Calls;
    u32 profMatrixBuildMatrix2Calls;
    ...
    while (prop != NULL)
    {
        ...
        if (prop->type == PROP_TYPE_CHR)
        {
            // TEMP
            {
                ...
                profMatrixBuildParentCycles = g_ProfChrMatrixBuildParentCycles;
                profMatrixBuildPrimaryCycles = g_ProfChrMatrixBuildPrimaryCycles;
                profMatrixBuildMatrix1Cycles = g_ProfChrMatrixBuildMatrix1Cycles;
                profMatrixBuildMatrix2Cycles = g_ProfChrMatrixBuildMatrix2Cycles;
                profMatrixBuildCalls = g_ProfChrMatrixBuildCalls;
                profMatrixBuildParentLookupCalls = g_ProfChrMatrixBuildParentLookupCalls;
                profMatrixBuildParentPresentCalls = g_ProfChrMatrixBuildParentPresentCalls;
                profMatrixBuildMatrix1Calls = g_ProfChrMatrixBuildMatrix1Calls;
                profMatrixBuildMatrix2Calls = g_ProfChrMatrixBuildMatrix2Calls;
                prof_t = osGetCount();
                g_ProfChrTickCalls++;
                tickop = chrTick(prop);
                ...
                if (profCycles > g_ProfChrSlowestCycles)
                {
                    ...
                    g_ProfChrSlowestMatrixBuildParentCycles = g_ProfChrMatrixBuildParentCycles - profMatrixBuildParentCycles;
                    g_ProfChrSlowestMatrixBuildPrimaryCycles = g_ProfChrMatrixBuildPrimaryCycles - profMatrixBuildPrimaryCycles;
                    g_ProfChrSlowestMatrixBuildMatrix1Cycles = g_ProfChrMatrixBuildMatrix1Cycles - profMatrixBuildMatrix1Cycles;
                    g_ProfChrSlowestMatrixBuildMatrix2Cycles = g_ProfChrMatrixBuildMatrix2Cycles - profMatrixBuildMatrix2Cycles;
                    g_ProfChrSlowestMatrixBuildCalls = g_ProfChrMatrixBuildCalls - profMatrixBuildCalls;
                    g_ProfChrSlowestMatrixBuildParentLookupCalls = g_ProfChrMatrixBuildParentLookupCalls - profMatrixBuildParentLookupCalls;
                    g_ProfChrSlowestMatrixBuildParentPresentCalls = g_ProfChrMatrixBuildParentPresentCalls - profMatrixBuildParentPresentCalls;
                    g_ProfChrSlowestMatrixBuildMatrix1Calls = g_ProfChrMatrixBuildMatrix1Calls - profMatrixBuildMatrix1Calls;
                    g_ProfChrSlowestMatrixBuildMatrix2Calls = g_ProfChrMatrixBuildMatrix2Calls - profMatrixBuildMatrix2Calls;
