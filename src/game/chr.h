...
PropRecord *something_with_weaponpos_of_guarddata_hand(ChrRecord *arg0, GUNHAND arg1);
PropRecord *is_weapon_in_guarddata_hand(ChrRecord *ChrRecord, GUNHAND arg1);
