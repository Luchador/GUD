...
#if defined(LEFTOVERDEBUG)
    dword_CODE_bss_8008C714 = 0x14;
#else
    dword_CODE_bss_8008C714 = 0x10;
#endif
...
/* 0F8030 7F0C3500 0FC3094C */  jal   mpCalculateAwards
...
/* 0F53D0 7F0C29E0 0FC30684 */  jal   mpCalculateAwards
