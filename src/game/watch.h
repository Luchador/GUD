...
typedef enum WATCH_OPTIONS_INDEX {
    OPTIONS_INDEX_MUSIC = 0,
    OPTIONS_INDEX_FX,
    OPTIONS_INDEX_LOOK_UPDOWN,
    OPTIONS_INDEX_AUTO_AIM,
    OPTIONS_INDEX_AIM_CONTROL,
    OPTIONS_INDEX_SIGHT_ONSCREEN,
    OPTIONS_INDEX_LOOK_AHEAD,
    OPTIONS_INDEX_AMMO_ONSCREEN,
    OPTIONS_INDEX_SCREEN_SIZE,
    OPTIONS_INDEX_RATIO
} WATCH_OPTIONS_INDEX;
