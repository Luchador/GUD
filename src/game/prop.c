...

{
    ...
    *puVar3 = 0xff;
    ...
    if (-1 < iVar1) {
        if (iVar1 < 10000) {
            pOVar4 = &ptr_0xxxpresets->pos + iVar1 * 0x2c;
        }
        else {
            pOVar4 = ptr_2xxxpresets + iVar1 * 0x44 + -680000;
        }
        pPVar2 = param_2->Prop;
        fVar7 = *(&pOVar4->type + 2);
        fVar8 = (pPVar2->pos).y;
...
/* 0356C8 7F002CD8 3C098006 */  lui   $t1, %hi(ptr_0xxxpresets) # $t1, 0x8006
/* 0356CC 7F002CDC 8D294C58 */  lw    $t1, %lo(ptr_0xxxpresets)($t1)
...
.L7F002CF0:
/* 0356E0 7F002CF0 3C0B8006 */  lui   $t3, %hi(ptr_2xxxpresets) # $t3, 0x8006
/* 0356E4 7F002CF4 8D6B4C5C */  lw    $t3, %lo(ptr_2xxxpresets)($t3)
...
/* 035E28 7F003438 3C088006 */  lui   $t0, %hi(ptr_2xxxpresets) # $t0, 0x8006
/* 035E2C 7F00343C 00197900 */  sll   $t7, $t9, 4
/* 035E30 7F003440 8D084C5C */  lw    $t0, %lo(ptr_2xxxpresets)($t0)
...
/* 03670C 7F003D1C 3C078006 */  lui   $a3, %hi(ptr_setup_path_tbl) # $a3, 0x8006
/* 036710 7F003D20 24E74C40 */  addiu $a3, %lo(ptr_setup_path_tbl) # addiu $a3, $a3, 0x4c40
...
/* 0368E0 7F003EF0 3C078006 */  lui   $a3, %hi(ptr_setup_path_tbl) # $a3, 0x8006
/* 0368E4 7F003EF4 24E74C40 */  addiu $a3, %lo(ptr_setup_path_tbl) # addiu $a3, $a3, 0x4c40
...
/* 036918 7F003F28 3C108006 */  lui   $s0, %hi(ptr_0xxxpresets) # $s0, 0x8006
/* 03691C 7F003F2C 8E104C58 */  lw    $s0, %lo(ptr_0xxxpresets)($s0)
...
.L7F003F90:
/* 036980 7F003F90 3C078006 */  lui   $a3, %hi(ptr_setup_path_tbl) # $a3, 0x8006
/* 036984 7F003F94 24E74C40 */  addiu $a3, %lo(ptr_setup_path_tbl) # addiu $a3, $a3, 0x4c40
...
/* 03699C 7F003FAC 3C078006 */  lui   $a3, %hi(ptr_setup_path_tbl) # $a3, 0x8006
/* 0369A0 7F003FB0 24E74C40 */  addiu $a3, %lo(ptr_setup_path_tbl) # addiu $a3, $a3, 0x4c40
...
/* 036A50 7F004060 3C078006 */  lui   $a3, %hi(ptr_setup_path_tbl) # $a3, 0x8006
/* 036A54 7F004064 24E74C40 */  addiu $a3, %lo(ptr_setup_path_tbl) # addiu $a3, $a3, 0x4c40
...
.L7F00427C:
/* 036C6C 7F00427C 3C0B8006 */  lui   $t3, %hi(ptr_setup_objects) # $t3, 0x8006
...
.L7F0042C8:
/* 036CB8 7F0042C8 3C128006 */  lui   $s2, %hi(ptr_setup_objects) # $s2, 0x8006
/* 036CBC 7F0042CC 8E524C4C */  lw    $s2, %lo(ptr_setup_objects)($s2)
...
/* 036FCC 7F0045DC 3C0D8006 */  lui   $t5, %hi(ptr_2xxxpresets) # $t5, 0x8006
...
/* 036FE0 7F0045F0 8DAD4C5C */  lw    $t5, %lo(ptr_2xxxpresets)($t5)
...
/* 0374A4 7F004AB4 3C128006 */  lui   $s2, %hi(ptr_setup_objects) # $s2, 0x8006
/* 0374A8 7F004AB8 8E524C4C */  lw    $s2, %lo(ptr_setup_objects)($s2)
...
/* 037610 7F004C20 0FC00644 */  jal   sub_GAME_7F001910
...
/* 0376CC 7F004CDC 0FC00650 */  jal   sub_GAME_7F001940
...
.L7F004E20:
/* 037794 7F004DA4 3C018006 */  lui   $at, %hi(ptr_setup_path_tbl) # $at, 0x8006
/* 037798 7F004DA8 AC204C40 */  sw    $zero, %lo(ptr_setup_path_tbl)($at)
/* 03779C 7F004DAC 3C018006 */  lui   $at, %hi(ptr_setup_path_link) # $at, 0x8006
/* 0377A0 7F004DB0 AC204C44 */  sw    $zero, %lo(ptr_setup_path_link)($at)
/* 0377A4 7F004DB4 3C018006 */  lui   $at, %hi(ptr_setup_intro) # $at, 0x8006
/* 0377A8 7F004DB8 AC204C48 */  sw    $zero, %lo(ptr_setup_intro)($at)
/* 0377AC 7F004DBC 3C018006 */  lui   $at, %hi(ptr_setup_objects) # $at, 0x8006
/* 0377B0 7F004DC0 AC204C4C */  sw    $zero, %lo(ptr_setup_objects)($at)
/* 0377B4 7F004DC4 3C018006 */  lui   $at, %hi(ptr_setup_path_sets) # $at, 0x8006
/* 0377B8 7F004DC8 AC204C50 */  sw    $zero, %lo(ptr_setup_path_sets)($at)
/* 0377BC 7F004DCC 3C018006 */  lui   $at, %hi(ptr_setup_actions) # $at, 0x8006
/* 0377C0 7F004DD0 AC204C54 */  sw    $zero, %lo(ptr_setup_actions)($at)
/* 0377C4 7F004DD4 3C018006 */  lui   $at, %hi(ptr_0xxxpresets) # $at, 0x8006
/* 0377C8 7F004DD8 AC204C58 */  sw    $zero, %lo(ptr_0xxxpresets)($at)
/* 0377CC 7F004DDC 3C018006 */  lui   $at, %hi(ptr_2xxxpresets) # $at, 0x8006
/* 0377D0 7F004DE0 AC204C5C */  sw    $zero, %lo(ptr_2xxxpresets)($at)
/* 0377D4 7F004DE4 3C018006 */  lui   $at, %hi(dword_CODE_bss_80075D20) # $at, 0x8006
/* 0377D8 7F004DE8 AC204C60 */  sw    $zero, %lo(dword_CODE_bss_80075D20)($at)
/* 0377DC 7F004DEC 3C018006 */  lui   $at, %hi(dword_CODE_bss_80075D24) # $at, 0x8006
/* 0377E0 7F004DF0 AC204C64 */  sw    $zero, %lo(dword_CODE_bss_80075D24)($at)
