...
void rspGfxTaskStart(Gfx *firstGdl, Gfx *gdl, s32 arg2, OSMesg rspReplyMsg)
{
    ...
    temp_s0 = &(*g_gfxTaskSettingsList)[0];
    t = &(*g_gfxTaskSettingsList)[0].task.list.t; // addiu	v0,s0,16
    ...
    t->ucode = gsp3DTextStart;
    
    //temp_s0->task.list.t.ucode_data = (u64*)gsp3DDataStart;
    t->ucode_data = gsp3DDataStart;
    ...
    temp_s0->task.framebuffer = (void *) g_gfxTaskSettingsList[0]->cfb;
