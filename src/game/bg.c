...
/* 0E8658 7F0B3B28 3C0F8004 */  lui   $t7, %hi(D_80041467)
...
.L7F0B3B3C:
/* 0E866C 7F0B3B3C 91EF1467 */  lbu   $t7, %lo(D_80041467)($t7)
...
/* 0EDEB0 7F0B9380 3C0B8008 */  lui   $t3, %hi9dword_CODE_bss_8007B128)
