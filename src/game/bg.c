 ...
 */
BgDrawSlot g_BgDrawSlots[MAXROOMCOUNT];

u8* g_BgData;
s32 g_StanData;
s32 g_BgSingleDisplayList;

char list_visible_rooms_in_cur_global_vis_packet[80];
...
*/
RoomInfo g_BgRoomInfo[MAXROOMCOUNT];
...
u8 g_PortalTraversalDepths[PORTMAX];
