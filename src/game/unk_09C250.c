...
s_smoketype array_smoke_types[] = {
      {0x1, 0x3C, 0x63,  0x00, 0.0f, 0x80, 0x80, 0x80, 0x00, 0.3f, 0xB4, 0x0000},
    {0x1E0, 0x3C, 0x2D,  0x3C,  0.02f, 0x50, 0x50, 0x60, 0x00, 0.3f, 0xB4, 0x0000},
    {0x1E0, 0x3C, 0x32,  0x14,  0.01f, 0x80, 0x80, 0x80, 0x00, 0.3f, 0xB4, 0x0000},
    {0x280, 0x3C, 0x78,  0x64,  0.01f, 0xC0, 0xC0, 0xC0, 0x00, 0.3f, 0xB4, 0x0000},
    {0x280, 0x3C, 0x3C,  0x50,  0.02f, 0x40, 0x40, 0x40, 0x00, 0.3f, 0xB4, 0x0000},
    {0x302, 0x3C, 0x32,  0xBE, 0.15f, 0x40, 0x40, 0x40, 0x00, 0.3f, 0xB4, 0x0000},
    {0x384, 0x3C, 0x46, 0x12C,  0.01f, 0x40, 0x40, 0x40, 0x00, 0.3f, 0xB4, 0x0000},
     {0x3C, 0x3C,  0x8,  0x0F,  0.03f, 0xFF, 0xFF, 0xFF, 0x00, 0.3f, 0xB4, 0x0000},
     {0x14, 0x01,  0x6,  0x1E,  0.03f, 0xFF, 0xFF, 0xFF, 0x00, 2.0f, 0x1E, 0x0000},
     {0x19, 0x01,  0x7,  0x10,  0.03f, 0xE0, 0xE0, 0xE0, 0x00, 3.0f, 0x1E, 0x0000},
    {0x384, 0x3C, 0x46, 0x384,  0.01f, 0x40, 0x40, 0x40, 0x00, 0.3f, 0xB4, 0x0000}
};
